...
@Entity
@Table(name = "TBR_CD_HSSTDDTL", schema = "dbo", catalog = "soo_MST"
		, uniqueConstraints = @UniqueConstraint(columnNames = {"HS", "HSCD", "HSLEVEL", "HSNO", "ITEMGBN"}))
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@Data
public class SooMst_CdHsStdDtlVO {
  @Id
  @GeneratedValue(strategy = GenerationType.AUTO)
  @Column(name = "KEY_CD_HSSTDDTL")
  private BigDecimal keyCdHsstddtl;
  ...
  @Column(name = "HSLEVEL", updatable = false)
  @NotEmpty
  @Size(max = 2)
  private String hslevel;

  @Column(name = "HSNO", updatable = false)
  @NotEmpty
  @Size(max = 50)
  private String hsno;
  ...
  @Column(name = "HSDIVI")
  @Size(max = 50)
  private String hsdivi;

  @Column(name = "ITEMNM")
  @Size(max = 100)
  private String itemnm;

  @Column(name = "ITEMGBNNM")
  @Size(max = 100)
  private String itemgbnnm;
