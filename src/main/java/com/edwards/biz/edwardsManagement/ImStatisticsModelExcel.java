...
public class ImStatisticsModelExcel implements ResultHandler<Map<String,Object>> {
	...
	public ImStatisticsModelExcel(HttpServletResponse response){
		...
		sheet.setColumnWidth(41, 4000);	//Invoice번호
		sheet.setColumnWidth(42, 4000);	//Invoice번호
		sheet.setColumnWidth(43, 1500);	//행번호
		sheet.setColumnWidth(44, 5000);	//제품코드
		sheet.setColumnWidth(45, 5000);	//제품명
		sheet.setColumnWidth(46, 2500);	//성분2
		sheet.setColumnWidth(47, 2000);	//수량
		sheet.setColumnWidth(48, 1500);	//수량단위
		sheet.setColumnWidth(49, 3000);	//단가
		sheet.setColumnWidth(50, 3000);	//금액
	}
	...
	public void handleResult(ResultContext<? extends Map<String, Object>> result){
		try {
			if(!isStarted){
        		...
        		response.setHeader("Content-Disposition","attachment;filename=\""+URLEncoder.encode("수입모델규격기준실적자료.xlsx", "UTF-8")+"\"");
        		isStarted = true;
        	...
        	cell.setCellStyle(style1);
        	cell = row.createCell(41);
        	cell.setCellValue(dataRow.get("ImpumIvNo")==null ? "" : dataRow.get("ImpumIvNo").toString());
        	cell.setCellStyle(style1);
        	cell = row.createCell(42);
        	cell.setCellValue(dataRow.get("SuipyogunNo")==null ? "" : dataRow.get("SuipyogunNo").toString());
        	cell.setCellStyle(style1);
        	cell = row.createCell(43);
        	cell.setCellValue(dataRow.get("ImpumHeang")==null ? "" : dataRow.get("ImpumHeang").toString());
        	cell.setCellStyle(style);
        	cell = row.createCell(44);
        	cell.setCellValue(dataRow.get("ImpumGukyk1")==null ? "" : dataRow.get("ImpumGukyk1").toString());
        	cell.setCellStyle(style1);
        	cell = row.createCell(45);
        	cell.setCellValue(dataRow.get("ImpumGukyk2")==null ? "" : dataRow.get("ImpumGukyk2").toString());
        	cell.setCellStyle(style1);
        	cell = row.createCell(46);
        	cell.setCellValue(dataRow.get("ImpumSungbun2")==null ? "" : dataRow.get("ImpumSungbun2").toString());
        	cell.setCellStyle(style1);
        	cell = row.createCell(47);
        	cell.setCellValue(Double.parseDouble(dataRow.get("ImpumSu").toString())==0 ? 0 : Double.parseDouble(dataRow.get("ImpumSu").toString()));
        	cell.setCellStyle(style20);
        	cell = row.createCell(48);
        	cell.setCellValue(dataRow.get("ImpumSuDanwi")==null ? "" : dataRow.get("ImpumSuDanwi").toString());
        	cell.setCellStyle(style);
        	cell = row.createCell(49);
        	cell.setCellValue(Double.parseDouble(dataRow.get("ImpumDanga").toString())==0 ? 0 : Double.parseDouble(dataRow.get("ImpumDanga").toString()));
        	cell.setCellStyle(style22);
        	cell = row.createCell(50);
        	cell.setCellValue(Double.parseDouble(dataRow.get("ImpumAmt").toString())==0 ? 0 : Double.parseDouble(dataRow.get("ImpumAmt").toString()));
        	cell.setCellStyle(style20);
		} catch (Exception e) {
