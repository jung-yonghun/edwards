...
public class ManageExcel1 implements ResultHandler<Map<String,Object>> {
	...
	public ManageExcel1(HttpServletResponse response){
	...
	public void handleResult(ResultContext<? extends Map<String, Object>> result){
		try {
        	...
        	cell.setCellStyle(style);
        	cell = row.createCell(21);
        	cell.setCellValue(dataRow.get("InDt")==null ? "" : dataRow.get("InDt").toString());
        	cell.setCellStyle(style);
        	cell = row.createCell(22);
        	cell.setCellValue(dataRow.get("Remark1")==null ? "" : dataRow.get("Remark1").toString());
        	cell.setCellStyle(style1);
		} catch (Exception e) {
