...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/engTpList.js'/>"></script>
	<style>
        #drop {
		        ...
		        <div data-options="region:'center'" style="width:50%;box-sizing:border-box;border:0px">
                      ...
                      <tr height="23px">
                        <td>
                          <select id="_DateType" name="_DateType" style="width:100px">
				  			<option value="Mreg_date" >D. Uploading</option>
				  			<option value="Mconfirm_date">D. Confirmed</option>
			    		  </select>
				  ...
				  <div class="normal_Top">
		            <form id="frm3" name="frm3" method="post">
	  	  	   		Reason for change <input type="text" id="amd_txt1" name="amdTxt1" style="width:80%"/>
			  	...
			  	<div data-options="region:'east',split:true" style="width:50%;box-sizing:border-box;border:0px">
			  	  <div id="p" class="easyui-panel" title="How to work" style="width:100%;height:182px;padding:10px;">
	        		1. After downloading "Item master data", rearrange the data based on reference number by using "vlookup". (Cell order: Reference number, Product number, Tpvalue) <br><br>
		            2. Drag & drop the excel file and conduct "validation check".<br><br>
		            3. Enter the reason for the TPValue change. <br><br>
		            4. Execute "Update" and it will be processed. Then you will see the "result".
	    		  </div><br>
	    		  <div class="normal_con01">
