...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/itemHsFtaIns.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
				...
				<div class="hsnew_C02_table">
				  ...
				  <table>
                    ...
                    <tr>
                      ...
                      <td colspan="5">
                        <input type="text" id="hsRegUserComName" name="hsRegUserComName"  placeholder="업체(거래처명)" value="${sessionScope.SANGHO}"/>
                        <a href="javascript:fn_customerSearch()"><img src="../images/cps/hs_seach.png" id="customerSearch" style="display:none"></a>
                        <input type="text" id="hsRegUserComTaxNum" name="hsRegUserComTaxNum"  placeholder="업체(사업자번호)" value="${sessionScope.TAXNO}"/>
