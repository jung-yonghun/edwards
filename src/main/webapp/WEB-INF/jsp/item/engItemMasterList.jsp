...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/engItemMasterList.js'/>"></script>
	<style>
    .custom-statusbar {
		    ...
		    <div class="container">
			  <div class="normal_cont">
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:90px">
                          ...
                          <option value="last_date" selected>D. Modified</option>
						</select>
					  </td>
					  <td>
				...
				<div id="pay" class="normal_Button" style="display:none">
				  ...
				  <a href="javascript:fn_updateAction();">Modify</a>
		    	    ...
		    	    <div class="easyui-tabs" id="tabs" data-options="fit:true,plain:true">
		    	      <div title="Details">
		    	        <div class="hsnew_C02_table">
                        	...
                        	<col width="22%">
	                          ...
	                          <td class="left">Discrepancy rate</td>
		    	      ...
		    	      <div title="Non-requirements items" style="padding:10px;">
			  	      ...
			  	      <div title="Duty rate & Clearance guidelines">
			  	        <!-- div class="normal_Button">
						  <a href="javascript:fn_hsData();">Duty rate</a>
		    	        ...
		    	        <div class="hsnew_C02_table">
                        	...
                        	<col width="30%">
	                          ...
	                          <td class="left">Customs duty</td>
	                          <td class="left">FTA</td>
	                      	</tr>
	                      	<tr>
	                          <td class="left">Product number</td>
	                          <td id="hsnum"></td>
	                          <td class="left">Unit(weight/Qty)</td>
	                          <td id="unit"></td>
