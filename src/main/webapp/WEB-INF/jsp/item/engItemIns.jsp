...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/engItemIns.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
				  ...
				  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="javascript:fn_ItemCheck();" class="easyui-linkbutton" style="margin-top:-3px"><font style="font-size:10px;">Duplicate check</font></a>
