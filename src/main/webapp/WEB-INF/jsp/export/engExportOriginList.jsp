...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/engExportOriginList.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
				...
				<div class="normal_Top">
				  ...
				  <table width="100%">
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:90px">
					      <option value="expo_LoadedDt_Day">D. Shipping</option>
						  <option value="Expo_singo_date_Day">D. Declaration</option>
						  <option value="Expo_ok_date_Day" selected="selected">D. Acceptance</option>
						</select>
					  </td>
					  <td>
					...
					<tr height="23px">
					  ...
					  <td></td>
					  <td>Contract #2</td>
					  <td><input type="text" id="expoGeyakNo2" name="expoGeyakNo2" onkeypress="keyDown()"/></td>
					  <td></td>
					  <td>Customs code</td>
					  <td>
					    <select id="expoSegwan" name="expoSegwan" style="width:130px" onchange='fn_searchAction()'></select>
					    <select id="expoGroupSegwan" name="expoGroupSegwan" style="width:80px;display:none" onchange='fn_searchAction()'>
					  ...
					  <td>Shipped Y/N</td>
					  <td>
					    <select id="expoLoadedYn" name="expoLoadedYn" style="width:60px">
					      <option value="">All</option>
