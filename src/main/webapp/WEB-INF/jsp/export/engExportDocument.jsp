...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/engExportDocument.js'/>"></script>
					  ...
					  <tr height="23px">
					      ...
					      <select id="_DateType" name="_DateType" style="width:90px">
					        <option value="expo_LoadedDt_Day">D. Shipping</option>
						  	<option value="Expo_singo_date_Day"  selected="selected">D. Declaration</option>
						  	<option value="Expo_ok_date_Day">D. Acceptance</option>
						  </select>
					  	</td>
					  	<td>
