...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/exportStats.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
			  ...
			  <div class="normal_cont">
			    <div class="normal_Top">
				  <form id="frm1" name="frm1">
	  	  		  <input type="hidden" id="db" 			name="db" 			value="${sessionScope.DEFAULTDB}" />
		  		  <input type="hidden" id="sessionId" 	name="sessionId" 	value="${sessionScope.ID}"/>
		  		  <input type="hidden" id="taxno" 		name="taxno" 		value="${sessionScope.TAXNO}">
				...
				<div class="easyui-tabs" id="tabs" data-options="fit:true,plain:true" style="width:100%;height:350px">
		          ...
		          <div title="수출실적" style="padding:10px;">
		  	        <div class="easyui-layout" style="width:100%;height:350px">
		        	  <div data-options="region:'center'" style="width:30%;box-sizing:border-box;border:0px">
		        	    <div class="normal_con01">
