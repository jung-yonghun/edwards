...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/exportBanipDocument.js'/>"></script>
	<style>
	    .custom-statusbar {
		    ...
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:775px">
			      ...
			      <div class="normal_Button">
				  	...
				  	<a href="javascript:fn_shipDocu(1);">선적서류</a>
				  	<a href="javascript:fn_shipDocu(2);">통관서류</a>
				  	<a href="javascript:fn_shipDocu(5);">운송서류</a>
				  	<a href="javascript:fn_shipDocu(3);">정산서류</a>
				   	<a href="javascript:fn_shipDocu(4);">기타서류</a>
				  </div>
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					      ...
					      <select id="_DateType" name="_DateType" style="width:60px">
						    ...
						    <option value="ban1VerifyDate" selected="selected">수리일</option>
						    <option value="ban1WrkDate">작성일</option>
						  </select>
					  	</td>
					  	<td>
