...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceApplyIns.js'/>"></script>
	<style>
    .custom-statusbar {
			  ...
			  <div class="normal_cont">
				...
				<div class="easyui-layout" style="width:100%;height:620px;padding:0px">
		    	    ...
		    	    <div class="hsnew_C02_table" style="margin-top:-13px;margin-left:10px">
		    	      <input type="hidden" id="ID" 			name="ID" 			value="${sessionScope.ID}">
				  	  ...
				  	  <input type="hidden" id="sangho" 		name="sangho" 		value="${sessionScope.SANGHO}"/>
		      	  	  ...
		      	  	  <input type="hidden" id="applyKey" name="applyKey" value="${param.applyKey}"/>
			  		  ...
			  		  <table>
                          ...
                          <td><input type="text" id="comNum" name="comNum" style="width:100%;" maxlength="10"  onkeydown="return fn_onlyNumber(event)"/></td>
                          <td class="left">대표자</td>
                          <td><input type="text" id="comCeo" name="comCeo" style="width:100%;" maxlength="10"  onkeydown="return fn_onlyNumber(event)"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">담당자</td>
                          <td><input type="text" id="comDamdang" name="comDamdang" style="width:100%;" maxlength="10"  onkeydown="return fn_onlyNumber(event)"/></td>
                      	  <td class="left">연락처</td>
                          <td><input type="text" id="comPhone" name="comPhone" style="width:100%;" maxlength="10"  onkeydown="return fn_onlyNumber(event)"/></td>
                      	</tr>
                      	<tr>
                      	...
                      	<tr>
                          <td class="left">용도</td>
                          <td colspan="3"><input type="text" id="usage" name="usage" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">서류번호1</td>
                          <td><input type="text" id="relationDocNo1" name="relationDocNo1" style="width:100%;"/></td>
                          <td class="left">서류번호2</td>
                          <td><input type="text" id="relationDocNo2" name="relationDocNo2" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
                      	...
                      	<tr>
                          <td class="left">신청일자</td>
                          <td><input type="text" id="applyDt" name="applyDt" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
                          <td class="left">확인일자</td>
                          <td><input type="text" id="confirmDt" name="confirmDt" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">확인번호</td>
                          <td colspan="3"><input type="text" id="confirmNum" name="confirmNum" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">서류발송처</td>
                          <td colspan="3"><input type="text" id="sendCom" name="sendCom" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">담당자</td>
                          <td><input type="text" id="sendDamdang" name="sendDamdang" style="width:100%;"/></td>
                          <td class="left">연락처</td>
                          <td><input type="text" id="sendPhone" name="sendPhone" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
		    	  ...
		    	  <div data-options="region:'center',split:true" style="width:50%;height:620px;box-sizing:border-box;border:0px">
		  	        <div class="easyui-layout" data-options="fit:true" style="width:100%;height:620px">
		              ...
		              <div data-options="region:'east',split:true" style="width:50%;height:130px;box-sizing:border-box;border:0px;overflow:hidden;">
						<form id="frm2" name="frm2">
                       	<input type="hidden" id="masterKey" name="masterKey" 	value="${param.applyKey}"/>
                       	<input type="hidden" id="gubun" 	name="gubun" 		value="NoFoodType1"/>
                       	<input type="hidden" id="useYn" 	name="useYn" 		value="Y"/>
                       	<div id="fileuploader" style="width:150px">파일찾기</div>
                   		</form>
		              </div>
		              <div data-options="region:'south',split:true" style="width:100%;height:490px;box-sizing:border-box;border:0px">
						<div class="normal_Button">
						  <a href="javascript:fn_itemInsertAction();">입력</a>
						  <a href="javascript:fn_itemModifyAction();">수정</a>
						  <a href="javascript:fn_itemDeleteAction();">삭제</a>
						</div>
						<div class="normal_con01">
