...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceMaster.js'/>"></script>
		    ...
		    <div class="container">
			  <div class="normal_cont">
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:60px">
					      <option value="addDtm" selected>등록일</option>
				...
				<div class="normal_Button">
				  ...
				  <a href="javascript:;" onclick="parent.addTab('요건 식품','../compliance/complianceSikpum.cps')">식품</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 전기','../compliance/complianceDetail1.cps')">전기</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 전파','../compliance/complianceDetail2.cps')">전파</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 공산품','../compliance/complianceDetail3.cps')">공산품</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 화장품','../compliance/complianceDetail4.cps')">화장품</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 자동차부품','../compliance/complianceDetail5.cps')">자동차부품</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 화학물질','../compliance/complianceDetail6.cps')">화학물질</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 방폭면제','../compliance/complianceDetail7.cps')">방폭면제</a>
				  <a href="javascript:;" onclick="parent.addTab('요건 의료기기','../compliance/complianceDetail8.cps')">의료기기</a>
				</div>
				<div class="easyui-layout" style="width:100%;height:600px">
		    	  ...
		    	  <div data-options="region:'east',split:true" style="width:100%;height:250px;box-sizing:border-box;border:0px">
		    	    <div class="easyui-tabs" data-options="fit:true,plain:true">
		    	      <div title="식품" style="padding:10px;">
			  	      </div>
		    	      <div title="전기" style="padding:10px;">
			  	        <div class="normal_con01">
					  	  <table id="detailGrid"></table>
						</div>
			  	      </div>
			  	      <div title="전파" style="padding:10px;">
			  	        <div class="normal_con01">
					  	  <table id="detailGrid1"></table>
						</div>
			  	      </div>
			  	      <div title="공산품" style="padding:10px;">
			  	      </div>
			  	      <div title="화장품" style="padding:10px;">
			  	      </div>
			  	      <div title="자동차부품" style="padding:10px;">
			  	      </div>
			  	      <div title="화학물질" style="padding:10px;">
			  	      </div>
			  	      <div title="방폭면제" style="padding:10px;">
			  	      </div>
			  	      <div title="의료기기" style="padding:10px;">
			  	      </div>
