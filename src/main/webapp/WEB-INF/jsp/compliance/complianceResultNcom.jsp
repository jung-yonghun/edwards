...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceResultNcom.js'/>"></script>
  </head>
  <body>
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:60px">
						  <option value="IssueDtm">신청일</option>
						  <option value="ProcessDtm">승인일</option>
						  <option value="Impo_ok_date" selected="selected">수리일</option>
						</select>
					  </td>
					  <td>
