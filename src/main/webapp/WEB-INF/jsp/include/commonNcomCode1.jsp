...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/include/commonNcomCode1.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		      ...
		      <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
		        <div class="normal_Top">
		          ...
		          <table width="100%">
				  	...
				  	<tr height="23px">
				  	  <td>상호</td>
				  	  <td><input type="text" id="sangho" name="sangho" onkeypress="keyDown()" style="ime-mode:inactive;text-transform:uppercase;"/></td>
				  	</tr>
				  	<tr height="23px">
				  	  <td>부호</td>
				  	  <td><input type="text" id="code1" name="code1" onkeypress="keyDown()"style="ime-mode:inactive;text-transform:uppercase;"/></td>
				  	</tr>
				  </table>
				  </form>
		        </div>
