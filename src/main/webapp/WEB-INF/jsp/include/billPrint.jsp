...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/include/billPrint.js?20231027'/>"></script>
	<style>
  ...
  <body>
    <form id="frm" name="frm" method="post">
	  ...
	  <table id="excel_body" cellpadding="5" cellspacing="0">
		  ...
		  <td colspan="8" style="border-left:2px #000000 solid;border-right:2px #000000 solid;" valign="top">
			...
			<table id="excel_body" cellpadding="1" cellspacing="0">
			  ...
			  <tr height="30px">
				...
				<td style="border-top:1px #000000 solid;border-right:1px #000000 solid;" align="center"><div id="MONEY_CD"></div></td>
			  </tr>
			  <tr height="30px">
				...
				<td style="border-top:1px #000000 solid;border-right:1px #000000 solid;" align="center"><div id="WT_UNIT"></div></td>
		...
		<tr height="30px">
		  <td colspan="2" style="border-top:1px #000000 solid;border-left:2px #000000 solid;border-right:1px #000000 solid;padding:5px">비용합계</td>
		...
		<tr height="30px">
		  <td colspan="2" style="border-top:1px #000000 solid;border-left:2px #000000 solid;border-right:1px #000000 solid;padding:5px">미수금</td>
		...
		<tr height="30px">
		  <td colspan="2" style="border-top:1px #000000 solid;border-left:2px #000000 solid;border-right:1px #000000 solid;padding:5px">이월잔액</td>
		  <td colspan="3" style="border-top:1px #000000 solid;border-right:1px #000000 solid;padding:5px" align="right"><div id="MISU_EK"></div></td>
		  <td colspan="3" style="border-top:1px #000000 solid;border-right:2px #000000 solid;padding:5px"></td>
		</tr>
		<tr height="30px">
		  <td colspan="2" style="border-top:1px #000000 solid;border-left:2px #000000 solid;border-right:1px #000000 solid;padding:5px">청구금액</td>
		  <td colspan="3" style="border-top:1px #000000 solid;border-right:1px #000000 solid;padding:5px" align="right"><div id="REQ_EK"></div></td>
		  <td colspan="3" style="border-top:1px #000000 solid;border-right:2px #000000 solid;padding:5px"><div id="REQ_EK_NOTE"></div></td>
		</tr>
		<tr height="200px">
		...
		<tr height="30px">
		  ...
		  <td style="border-top:1px #000000 solid;border-right:1px #000000 solid;border-bottom:2px #000000 solid;" align="center">청구번호</td>
