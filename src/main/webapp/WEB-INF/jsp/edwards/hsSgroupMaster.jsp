...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/hsSgroupMaster.js?20231227'/>"></script>
	<style>
        #drop1 {
			  ...
			  <div class="easyui-layout" style="width:100%;height:735px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:360px">
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:32px;margin-top:32px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <input type="hidden" id="taxNum" 					name="taxNum" 			value="${sessionScope.TAXNO}">
				  	  ...
				  	  <input type="hidden" id="KEY_ED_HS_SPCL_GRP_MST" 	name="KEY_ED_HS_SPCL_GRP_MST">
				  	  <input type="hidden" id="HS_SPCL_MNG_NO" 			name="HS_SPCL_MNG_NO">
			  		  <table>
		   	    	  	<col width="20%"/>
                      	<col width="80%"/>
                      	<col width="23%"/>
                          ...
                          <td class="left">구분</td>
                          <td>
                            <select id="DIV_NM" name="DIV_NM" style="width:100px" onchange="fn_changeDiv(this)"></select>
                            <input type="hidden" id="DIV_CD" name="DIV_CD" style="width:100%;"/>
                          </td>
                      	</tr>
                      	<tr>
                          <td class="left">그룹명</td>
                          <td>
                            <select id="GRP_NM" name="GRP_NM" style="width:120px" onchange="fn_changeGrp(this)"></select>
                            <input type="hidden" id="GRP_CD" name="GRP_CD" style="width:100%;"/>
                          </td>
                      	</tr>
                      	<tr>
                          <td class="left">비고</td>
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					  	<td>그룹코드</td>
					  	<td><input type="text" id="HS_SPCL_MNG_NO1" name="HS_SPCL_MNG_NO1" onkeypress="keyDown()"/></td>
					  	<td></td>
					  	<td>그룹명</td>
					  	<td><input type="text" id="GRP_NM1" name="GRP_NM1" onkeypress="keyDown()"/></td>
					  </tr>
				  	</table>
				  </div>
				  <div class="normal_Button">
			  	...
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:8px;margin-top:8px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <div class="hsnew_C02_table" style="margin-top:-10px">
				  	  ...
				  	  <input type="hidden" id="ID" 						name="ID" 				value="${sessionScope.ID}">
				  	  <input type="hidden" id="KEY_ED_HS_SPCL_GRP_DTL" 	name="KEY_ED_HS_SPCL_GRP_DTL">
		    	    ...
		    	    <div title="엑셀등록" style="padding:10px">
				      ...
				      <script>
					    ...
					    function process_wb1(wb) {
					        ...
					        var aabb = JSON.parse(output).hsSgroupCodeMaster;
					        var aacc = new Array();
