...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/itemIns.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		    ...
		    <div class="easyui-layout" style="width:900px;height:700px;">
		      <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
				...
				<div class="hsnew_C02_table">
				  ...
				  <input type="hidden" id="Mtcano" 			name="Mtcano"		value="43862">
				  <input type="hidden" id="Mco_code" 		name="Mco_code" 	value="000R">
				  <table>
			   	    <col width="15%">
                    <col width="35%">
                    <col width="15%">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="MmakerCD" name="MmakerCD" style="width:60px" readOnly onclick="javascript:fn_searchVendor()"/>
