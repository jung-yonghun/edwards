...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/bbsWrite.js?20231227'/>"></script>
			  ...
			  <div class="easyui-layout" style="width:100%;height:775px">
		        ...
		        <div data-options="region:'east',split:true" style="width:50%;box-sizing:border-box;border:0px">
		          <div class="normal_Button" style="margin-top:5px;">
				  	<a href="javascript:fn_insertAction();">신규</a>
				  ...
				  <form name="tx_editor_form" id="tx_editor_form" accept-charset="utf-8">
					...
					<input type="hidden" id="NTAAKey" 			name="NTAAKey" value="${param.NTAAKey}"/>
					...
					<table width="100%">
					  ...
					  <tr>
						<td class="left">구분</td>
						<td>
						  <select id="Keyword" name="Keyword" style="width:100px;">
			        		<option value="일반질의">일반질의</option>
			        		<option value="HSK질의">HSK질의</option>
			      		  </select>
			      		</td>
					  </tr>
					  <tr>
