...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/coMaster.js?20231227'/>"></script>
	<style>
        #drop {
		  ...
		  <div class="right1">
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:735px">
			    <div data-options="region:'north',split:true" style="width:100%;height:405px;box-sizing:border-box;border:0px">
			    <div class="easyui-layout" style="width:100%;height:400px">
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:33px;margin-top:33px;">
			  	<input type="hidden" id="taxNum" 	name="taxNum" 		value="${sessionScope.TAXNO}">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <div class="hsnew_C02_table" style="margin-top:-10px">
				  	  ...
				  	  <input type="hidden" id="KEY_ED_CO_MST" 	name="KEY_ED_CO_MST">
				  	  <input type="hidden" id="CO_ORDR_MNG_NO" 	name="CO_ORDR_MNG_NO">
			  		  <table>
		   	    	  	<col width="20%"/>
                      	<col width="80%"/>
                      	<col width="23%"/>
                          ...
                          <td>
                            <select id="EXIM_DIV" name="EXIM_DIV" style="width:70px;">
                          ...
                          <td><input type="text" id="FRGN_COMP_NM" name="FRGN_COMP_NM" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">원산지증명번호</td>
                          <td><input type="text" id="CO_NO" name="CO_NO" style="width:200px;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">FTA비적용</td>
                          <td>
                            <select id="NOTFTA_FG" name="NOTFTA_FG" style="width:70px;">
                      	...
                      	<tr>
                          <td class="left">시작일</td>
                          <td><input type="text" id="STRT_DT" name="STRT_DT" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">종료일</td>
                          <td><input type="text" id="END_DT" name="END_DT" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">비고</td>
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					    <td>
					  	  <select id="NOCHK" name="NOCHK" style="width:110px;">
                            <option value="CO_NO">원산지증명번호</option>
                            <option value="FRGN_COMP_NM">업체명</option>
                          </select>
					  	</td>
					  	<td><input type="text" id="NODATA" name="NODATA" onkeypress="keyDown()" style="width:300px;"/></td>
					  	<td></td>
					  	<td>시작일자</td>
				  	...
				  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:3px;margin-top:3px;">
			    	    ...
			    	    <div title="일반등록">
			    	      ...
			    	      <div class="hsnew_C02_table" style="margin-top:-10px">
					  	  ...
					  	  <input type="hidden" id="ID" 				name="ID" 				value="${sessionScope.ID}">
					  	  <input type="hidden" id="KEY_ED_CO_DTL" 	name="KEY_ED_CO_DTL">
					  	  <input type="hidden" id="CO_ORDR_MNG_NO" 	name="CO_ORDR_MNG_NO">
				  		  ...
				  		  <table>
	                          ...
	                          <td>
	                            <input type="text" id="ITEM_CD" name="ITEM_CD" style="width:200px;"/>
	                            <a href="javascript:fn_jajaeSearch()"><img src="../images/cps/hs_seach.png" id="ddealSearch">
	                          </td>
	                      	</tr>
	                      	<tr>
	                          <td class="left">아이템명</td>
	                          <td><input type="text" id="ITEM_NM" name="ITEM_NM" style="width:100%;"/></td>
	                      	</tr>
	                      </table>
	                      </form>
		                  </div>
			    	    ...
			    	    <div title="엑셀등록" style="padding:10px">
					      ...
					      <script>
						    ...
						    function process_wb(wb) {
						        ...
						        var aabb = JSON.parse(output).coMasterItem;
						        var aacc = new Array();

					        	for(var i = 0; i < aabb.length; i++){
					        		aabb[i].ITEM_CD = aabb[i].아이템코드;
					        		aabb[i].ITEM_NM	= aabb[i].아이템명;
					        		aacc.push(aabb[i]);
					        	}
					        	console.log(aacc);
