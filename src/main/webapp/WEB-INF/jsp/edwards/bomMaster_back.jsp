			  	...
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:33px;margin-top:33px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <div class="hsnew_C02_table" style="margin-top:-10px">
				  	  ...
				  	  <input type="hidden" id="KEY_ED_BOM_MST" 	name="KEY_ED_BOM_MST">
			  		  ...
			  		  <table>
                          ...
                          <td>
                            <input type="text" id="BOM_CD" name="BOM_CD" style="width:200px"/>
                            <a href="javascript:fn_jajaeSearch()"><img src="../images/cps/hs_seach.png" id="ddealSearch"></a>
                          </td>
                      	</tr>
                      	<tr>
                          <td class="left">아이템명</td>
                          <td><input type="text" id="BOM_NM" name="BOM_NM" style="width:100%;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">Revision번호</td>
                          <td><input type="text" id="REVSN_NO" name="REVSN_NO" style="width:50px;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">Revision일시</td>
                          <td><input type="text" id="REVSN_DTTM" name="REVSN_DTTM" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">단위</td>
                          <td><input type="text" id="QTY_UNIT" name="QTY_UNIT" style="width:70px;"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">감면수요계획</td>
                          <td>
                            <select id="DEMD_PLAN_FG" name="DEMD_PLAN_FG" style="width:50px;">
                      	...
                      	<tr>
                          <td class="left">감면용도이행</td>
                          <td>
                            <select id="USE_EXEC_FG" name="USE_EXEC_FG" style="width:50px;">
                              <option value="Y">Y</option>
                              <option value="N">N</option>
                            </select>
                          </td>
                      	...
                      	<tr>
                          <td class="left">환급사용</td>
                          <td>
                            <select id="REFUND_USE_FG" name="REFUND_USE_FG" style="width:50px;">
                              <option value="Y">Y</option>
                              <option value="N">N</option>
                            </select>
                          </td>
		    	    ...
		    	    <!-- div title="엑셀등록" style="padding:10px">
				      ...
				      <script>
					    ...
					    function process_wb(wb) {
					        ...
					        var aabb = JSON.parse(output).Worksheet;
					        var aacc = new Array();
			  	...
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:8px;margin-top:8px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <div class="hsnew_C02_table" style="margin-top:-10px">
				  	  ...
				  	  <input type="hidden" id="ID" 				name="ID" 				value="${sessionScope.ID}">
				  	  <input type="hidden" id="KEY_ED_BOM_DTL" 	name="KEY_ED_BOM_DTL">
				  	  <input type="hidden" id="COMP_CD" 		name="COMP_CD">
				  	  <input type="hidden" id="SEQNO" 			name="SEQNO">
				  	  <input type="hidden" id="BOM_CD" 			name="BOM_CD">
				  	  <input type="hidden" id="REVSN_NO" 		name="REVSN_NO">
			  		  <table>
		   	    	  	<col width="20%"/>
                      	<col width="80%"/>
                      	<col width="23%"/>
                          ...
                          <td>
                            ...
                            <a href="javascript:fn_jajaeSearch1()"><img src="../images/cps/hs_seach.png" id="ddealSearch"></a>
                          </td>
                      	</tr>
                      	<tr>
		    	    ...
		    	    <div title="엑셀등록" style="padding:10px">
				      ...
				      <script>
					    ...
					    function process_wb1(wb) {
					        ...
					        var aabb = JSON.parse(output).bomMasterCode;
					        var aacc = new Array();

				        	for(var i = 0; i < aabb.length; i++){
				        		aabb[i].ITEM_CD = aabb[i].자재코드;
				        		aabb[i].ITEM_NM = aabb[i].자재명;
