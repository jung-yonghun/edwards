...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/comMaster.js?20231227'/>"></script>
	<style>
        #drop {
			  ...
			  <div class="easyui-layout" style="width:100%;height:708px">
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:32px;margin-top:32px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <input type="hidden" id="taxNum" 			name="taxNum" 			value="${sessionScope.TAXNO}">
				  	  ...
				  	  <input type="hidden" id="KEY_ED_COMP" 	name="KEY_ED_COMP">
			  		  <table>
		   	    	  	<col width="20%"/>
                      	<col width="80%"/>
                      	<col width="23%"/>
		      		  	<tr>
                          <td class="left">코드</td>
                          <td><input type="text" id="COMP_CD" name="COMP_CD" style="width:100px"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">상호</td>
                          <td><input type="text" id="COMP_NM" name="COMP_NM" style="width:100%"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">ZONE</td>
                          <td><input type="text" id="BZTP" name="BZTP" style="width:30px"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">Plant</td>
                          <td><input type="text" id=PLantNo name="PLantNo" style="width:100%"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">Vendor</td>
                          <td>
                            <select id="VENDOR_FG" name="VENDOR_FG" style="width:50px;">
                      	...
                      	<tr>
                          <td class="left">인증수출자</td>
                          <td>
                            <select id="ORIG_CDOC_ISSU_FG" name="ORIG_CDOC_ISSU_FG" style="width:50px;">
                              <option value="Y">Y</option>
                              <option value="N">N</option>
                            </select>
                          </td>
                      	...
                      	<!-- tr>
                          <td class="left">감면수요계획사용</td>
                          <td>
                            <select id="EXEM_DEMD_PLAN_FG" name="EXEM_DEMD_PLAN_FG" style="width:50px;">
                              <option value="Y">Y</option>
                              <option value="N">N</option>
                            </select>
                          </td>
                      	...
                      	<tr>
                          <td class="left">특수관계여부</td>
                          <td>
                            <select id="SPCL_REL_FG" name="SPCL_REL_FG" style="width:50px;">
                              <option value="Y">Y</option>
                              <option value="N">N</option>
                            </select>
                          </td>
		    	    ...
		    	    <div title="엑셀등록" style="padding:10px">
				      ...
				      <script>
					    ...
					    function process_wb(wb) {
					        ...
					        var aabb = JSON.parse(output).comMaster;
					        var aacc = new Array();

				        	for(var i = 0; i < aabb.length; i++){
				        		aabb[i].COMP_CD 			= aabb[i].업체코드;
				        		aabb[i].BZTP 				= aabb[i].ZONE;
				        		aabb[i].COMP_NM 			= aabb[i].상호;
				        		aabb[i].VENDOR_FG 			= aabb[i].Vendor;
				        		aabb[i].ORIG_CDOC_ISSU_FG 	= aabb[i].인증수출자;
				        		aabb[i].EXEM_DEMD_PLAN_FG 	= aabb[i].감면수요계획사용;
				        		aabb[i].SPCL_REL_FG 		= aabb[i].특수관계여부;
				        		aabb[i].USE_FG 				= aabb[i].상태;
				        		aacc.push(aabb[i]);
				        	}
				        	console.log(aacc);
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					  	...
					  	<td></td>
					  	<td>상호</td>
					  	<td><input type="text" id="COMP_NM1" name="COMP_NM1" onkeypress="keyDown()"/></td>
					  </tr>
				  	</table>
				  </div>
				  <div class="normal_Button">
