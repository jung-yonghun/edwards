...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/exportDrawCheck3.js?250217'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
			  ...
			  <div class="easyui-layout" style="width:100%;height:700px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:680px">
		      	<div data-options="region:'center'" style="width:100%;box-sizing:border-box;border:0px">
		      	  #관세환급 조정고시 별표 1 + 별표2에 해당하는 아이템입니다. 계산을 진행하시면 다음 계산화면이 나타납니다.<br>
