...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/ReExportUpdatePop2.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		<div class="cont_con ovH">
		  <div class="right1">
		    <div class="easyui-layout" style="width:600px;height:430px;">
		      <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
				...
				<div class="hsnew_C02_table">
				  ...
				  <input type="hidden" id="EXPT_QTYORI" 		  name="EXPT_QTYORI">
				  <input type="hidden" id="REEX_END_DT" 		  name="REEX_END_DT">
				  <input type="hidden" id="EHEANG_END_DT" 		  name="EHEANG_END_DT">
				  <input type="hidden" id="YONGDO_DT" 		  	  name="YONGDO_DT">
				  <input type="hidden" id="DELAY_SEQ" 		  	  name="DELAY_SEQ">
				  <input type="hidden" id="INV_NO" 		  	 	  name="INV_NO">
				  <input type="hidden" id="EXPT_DECL_NO" 		  name="EXPT_DECL_NO">
				  <input type="hidden" id="EXPT_LAN" 		  	  name="EXPT_LAN">
				  <input type="hidden" id="EXPT_HNG" 		  	  name="EXPT_HNG">
				  <input type="hidden" id="EXPT_CMPL_DT" 		  name="EXPT_CMPL_DT">
				  <input type="hidden" id="EXPT_QTY" 		  	  name="EXPT_QTY">
				  <input type="hidden" id="EXPT_GURAE_GBN" 		  name="EXPT_GURAE_GBN">
				  <input type="hidden" id="NameOfShipto" 		  name="NameOfShipto">
				  <table>
			   	    <col width="15%">
                    <col width="35%">
                    <col width="15%">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="SoNo" name="SoNo"/>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="text" id="ExEmNo" name="ExEmNo"/>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="text" id="PROD_CD" name="PROD_CD"/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">Description</td>
                      <td>
                        <input type="text" id="PROD_NM" name="PROD_NM"/>
                      </td>
                      <td class="left">잔량</td>
                      <td>
