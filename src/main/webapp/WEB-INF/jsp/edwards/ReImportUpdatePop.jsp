...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/ReImportUpdatePop.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		<div class="cont_con ovH">
		  <div class="right1">
		    <div class="easyui-layout" style="width:600px;height:330px;">
		      <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
				<div class="normal_Button">
				  <a href="javascript:fn_saveAction();">수정</a>
				...
				<div class="hsnew_C02_table">
				  ...
				  <input type="hidden" id="KEY_ED_REIMPT_MASTER"  name="KEY_ED_REIMPT_MASTER" value="${param.KEY_ED_REIMPT_MASTER}">
				  ...
				  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="INV_NO" name="INV_NO" style="background-color:#e2e2e2" readOnly/>
                      </td>
                      <td class="left">수출신고번호</td>
                      <td>
                        <input type="text" id="EXPT_DECL_NO" name="EXPT_DECL_NO" style="background-color:#e2e2e2" readOnly/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">수출 란</td>
                      <td>
                        <input type="text" id="EXPT_LAN" name="EXPT_LAN" style="width:20%;background-color:#e2e2e2" readOnly/>
                      </td>
                      <td class="left">수출 행</td>
                      <td>
                        <input type="text" id="EXPT_HNG" name="EXPT_HNG" style="width:20%;background-color:#e2e2e2" readOnly/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">수출수리일</td>
                      <td>
                        <input type="text" id="EXPT_CMPL_DT" name="EXPT_CMPL_DT" style="width:30%;background-color:#e2e2e2" readOnly/>
                      </td>
                      <td class="left">수출량</td>
                      <td>
                        <input type="text" id="EXPT_QTY" name="EXPT_QTY" style="width:20%;background-color:#e2e2e2" readOnly/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">수출거래구분</td>
                      <td>
                        <input type="text" id="EXPT_GURAE_GBN" name="EXPT_GURAE_GBN" style="width:20%;background-color:#e2e2e2" readOnly/>
                      </td>
                      <td class="left">Name of Shipto</td>
                      <td>
                        <input type="text" id="NameOfShipto" name="NameOfShipto" style="background-color:#e2e2e2" readOnly/>
                      </td>
                    </tr>
                    <tr>
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="IMPT_DECL_NO" name="IMPT_DECL_NO"/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">수입 란</td>
                      <td>
                        <input type="text" id="IMPT_LAN" name="IMPT_LAN" style="width:20%"/>
                      </td>
                      <td class="left">수입 행</td>
                      <td>
                        <input type="text" id="IMPT_HNG" name="IMPT_HNG" style="width:20%"/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">수입수리일</td>
                      <td>
                        <input type="text" id="IMPT_CMPL_DT" name="IMPT_CMPL_DT" style="width:30%"/>
                      </td>
                      <td class="left">수입량</td>
                      <td>
                        <input type="text" id="IMPT_QTY" name="IMPT_QTY" style="width:20%"/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">수입거래구분</td>
                      <td>
                        <input type="text" id="IMPT_GURAE_GBN" name="IMPT_GURAE_GBN" style="width:20%"/>
                      </td>
                      <td></td>
                      <td></td>
                    </tr>
