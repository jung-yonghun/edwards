...
%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/import/importDeliveryList1.js'/>"></script>
	<style>
	    .custom-statusbar {
		    ...
		    <div class="container">
			  <div class="normal_cont">
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:70px">
                          ...
                          <option value="requestDate">운송의뢰일</option>
                          <option value="allocateRequestDate"  selected="selected">배차요청일</option>
					...
					<tr height="23px">
					  ...
					  <td>
					    <select id="deliveryStatus" name="deliveryStatus" style="width:80px" onChange="fn_searchAction()">
                            ...
                            <option value="30" selected="selected">배차요청</option>
				...
				<div class="normal_Button">
				  ...
				  <a href="javascript:fn_printAction();">POD 출력</a>
				  <a href="javascript:fn_carReturnAction();">배차완료 취소</a>
				  <a href="javascript:fn_deliveryAction();">배송중</a>
				  <a href="javascript:fn_deliveryOkAction();">배송완료</a>
				  <a href="javascript:fn_deliveryCompleteCostTransferAction();">정산처리</a>
	                      ...
	                      <table width="100%">
	                          ...
	                          <td>
	                          	<select id="edmsFileCategory" name="edmsFileCategory" style="width:80px;">
	                          	  <option value="C0002">인수증</option>
	                          	  <option value="C0003">운송서류</option>
	                          	  <option value="A0001">B/L</option>
	                          	  <option value="B0001">신고필증</option>
	                          	</select>
	                          </td>
	                      	</tr>
	                      </table>
					  ...
					  <div title="운송의뢰 상세" style="padding:2px;">
						  ...
						  <table>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" id="assignId" name="assignId" style="width:100%;" maxlength="20" readOnly/>
                              </td>
                            </tr>
                            <tr>
                              <td class="left">접수자</td>
                              <td>
                                <input type="text" id="assignMan" name="assignMan" style="width:100%;" maxlength="20" readOnly/>
                              </td>
                            </tr>
                            <tr>
                              <td class="left">연락처</td>
                              <td>
                                <input type="text" id="assignPhone" name="assignPhone" style="width:100%;" maxlength="15" readOnly/>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" id="deliveryPojangSu" name="deliveryPojangSu" style="width:50px;text-align:right" readOnly/>
                                <input type="text" id="deliveryPojangDanwi" name="deliveryPojangDanwi" style="width:30px;" readOnly/>
                              </td>
                            </tr>
                            <tr>
                              <td class="left">의뢰중량</td>
                              <td>
                                <input type="text" id="deliveryJung" name="deliveryJung" style="width:50px;text-align:right" readOnly/>
                                <input type="text" id="deliveryJungDanwi" name="deliveryJungDanwi" style="width:30px;" readOnly/>
                              </td>
                            </tr>
                            <tr>
                              <td class="left">사이즈</td>
                              <td>
                                <input type="text" id="cargoSize" name="cargoSize" style="width:30%;" readOnly/>
                              </td>
                            </tr>
                            <tr>
                              <td class="left">온도조건</td>
                              <td>
                                <input type="text" id="banipPlace" name="banipPlace" style="width:30%;" readOnly/>
                              </td>
                            </tr>
                            <tr>
                              <td class="left">착지</td>
                              <td>
                                <textarea type="text" id="requestInvisibleNote" name="requestInvisibleNote" style="width:100%;" readOnly></textarea>
                              </td>
                            </tr>
					      </table>
					      </form>
			  	      ...
			  	      <div title="배차정보 상세" style="padding:2px;">
			  	        <div class="normal_Button">
					   	  <a href="javascript:fn_carSave();">배차완료</a>
					   	  <a href="javascript:fn_damageSave();">Damage 저장</a>
					   	  <a href="javascript:fn_saveBundleUpCarCom();">일괄배차완료</a>
					  	</div>
					  	<div class="hsnew_C02_table">
						  ...
						  <table>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" id="deliveryCarKey" name="deliveryCarKey"/>
                                <input type="text" id="deliveryCarName" name="deliveryCarName" style="width:80%;" readOnly/>
                                <a href="javascript:fn_carSearch();"><img src="../images/cps/hs_seach.png"></a>
                              </td>
                            </tr>
                            <tr>
					  ...
					  <table id="masterGrid">
					    <thead>
				          <tr>
				          	...
				          	<th data-options="field:'assignId',hidden:true" rowspan="2">요청자</th>
				          	<th data-options="field:'addUserId',hidden:true" rowspan="2">등록자</th>
				            ...
				            <th data-options="field:'assignMan',width:60,align:'center'" rowspan="2">요청자</th>
				            <th data-options="field:'allocateRequestDate',width:120,align:'center',formatter:linkDateTimeFormatter" rowspan="2">요청일</th>
				          ...
				          <tr>
				            <th data-options="field:'deliveryCarKey',hidden:true">CarKey</th>
				            ...
				            <th data-options="field:'deliveryCarryingInAddr',hidden:true">착지주소</th>
				            <th data-options="field:'deliveryCarryingInEmail',hidden:true">착지메일</th>
				          </tr>
				        </thead>
					  </table>
					</div>
					  ...
					  <table id="excelGrid">
					    <thead>
				          <tr>
				            ...
				            <th data-options="field:'assignMan',width:60,align:'center'">요청자</th>
				            <th data-options="field:'allocateRequestDate',width:60,align:'center'">요청일</th>
