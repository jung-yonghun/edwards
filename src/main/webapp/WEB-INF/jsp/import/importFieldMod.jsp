...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/import/importFieldMod.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		  ...
		  <div class="right1">
		    ...
		    <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
	  	      ...
	  	      <div class="hsnew_C02_table">
	  	        ...
	  	        <input type="hidden" id="fieldMngKey" 	name="fieldMngKey" 	value="${param.fieldMngKey}" />
                <input type="hidden" id="editUserId" 	name="editUserId" 	value="${sessionScope.ID}"/>
