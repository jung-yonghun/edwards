...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/import/importWarehousePop2.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		  ...
		  <div class="right1">
		    <div class="container">
			  <div class="normal_cont">
				...
				<input type="hidden" id="strFromDate1" 	name="strFromDate1" value="${param.strFromDate1}" />
				<input type="hidden" id="strToDate1" 	name="strToDate1"  	value="${param.strToDate1}" />
