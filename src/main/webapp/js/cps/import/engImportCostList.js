		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'OWNER_COM_NM',title:'Taxpayer',width:200},
	                {field:'HAWB',title:'B/L No.',width:120,formatter:linkBlNoFormatter},
	                {field:'FULLSINGONO',title:'Declaration No.',width:120,align:'center',formatter:linkSingoFormatter},
	                ...
	                {field:'SUPLY_NM',title:'Supplier',width:250},
			...
			$('#excelGrid').datagrid({
				...
				columns	: [[
	                ...
	                {field:'OWNER_COM_NM',title:'Taxpayer'},
			...
			$('#fileGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'edmsOrgFileNm',title:'File name',width:170},
