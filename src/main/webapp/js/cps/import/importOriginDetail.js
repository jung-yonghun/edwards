function selectImportOriginDetail(){
    ...
    sendAjax(url, params, type, function(d){
        ...
        if(parseInt(Impo_mrn_noRe.length) < 16){
        ...
        $('#Impo_iphang_date').html(d[0].Impo_iphang_date.substr(0,4)+"/"+d[0].Impo_iphang_date.substr(4,2)+"/"+d[0].Impo_iphang_date.substr(6,2));
        $('#impo_cs').html(d[0].impo_cs);
        $('#Impo_bl_no').html(d[0].Impo_bl_no);
        $('#Impo_mbl_no').html(d[0].Impo_mbl_no);
        $('#Impo_mrn_no').html(Impo_mrn_no);
        $('#Impo_banip_date').html(d[0].Impo_banip_date.substr(0,4)+"/"+d[0].Impo_banip_date.substr(4,2)+"/"+d[0].Impo_banip_date.substr(6,2));
        ...
        $('#Impo_jubsu_date').html(d[0].Impo_jubsu_date.substr(0,4)+"/"+d[0].Impo_jubsu_date.substr(4,2)+"/"+d[0].Impo_jubsu_date.substr(6,2)+" "+d[0].Impo_jubsu_date.substr(8,2)+":"+d[0].Impo_jubsu_date.substr(10,2));
        $('#Impo_ok_date').html(d[0].Impo_ok_date.substr(0,4)+"/"+d[0].Impo_ok_date.substr(4,2)+"/"+d[0].Impo_ok_date.substr(6,2));
