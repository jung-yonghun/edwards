		...
		$(function(){
			...
			$('#detailGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'Etc01',title:'제조번호2',width:80},
	                {field:'Etc02',title:'제조일자2',width:60,align:'center'},
	                {field:'Etc03',title:'제조번호3',width:80},
	                {field:'Etc04',title:'제조일자3',width:60,align:'center'},
	                {field:'Etc05',title:'제조번호4',width:80},
	                {field:'Etc06',title:'제조일자4',width:60,align:'center'},
	                {field:'Etc07',title:'제조번호5',width:80},
	                {field:'Etc08',title:'제조일자5',width:60,align:'center'},
	                {field:'Etc09',title:'제조번호6',width:80},
	                {field:'Etc10',title:'제조일자6',width:60,align:'center'},
	                {field:'Etc11',title:'제조번호7',width:80},
	                {field:'Etc12',title:'제조일자7',width:60,align:'center'},
	                {field:'Etc13',title:'제조번호8',width:80},
	                {field:'Etc14',title:'제조일자8',width:60,align:'center'},
	                {field:'Etc15',title:'제조번호9',width:80},
	                {field:'Etc16',title:'제조일자9',width:60,align:'center'},
	                {field:'Etc17',title:'제조번호10',width:80},
	                {field:'Etc18',title:'제조일자10',width:60,align:'center'},
		        ]]
			});
	    });
...
var fn_DetailAction = function (ApplyNo){
	...
	progress.show();
	var url 	= "../apis/compliance/selectResultMasterList",
		params 	= {"ApplyNo" : ApplyNo, "RqGbn" : "CD"},
		type 	= "POST";
