		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'yogTitle',title:'요건항목',width:150},
	                ...
	                {field:'blNo',title:'B/L No.',width:150,formatter:linkBlNoFormatter},
	                {field:'jajaeCode',title:'자재코드',width:150},
	                {field:'yogSu',title:'수량',width:40,align:'right',formatter:linkNumberFormatter0},
	                {field:'certiNum',title:'인증번호',width:100,align:'center'},
	                {field:'productName',title:'품명',width:100,align:'center'},
	                {field:'modelName',title:'인증서상 모델명',width:200,align:'center'},
	                {field:'productCom',title:'제조사명',width:100,align:'center'},
	                ...
	                {field:'jung',title:'건수',width:40,align:'right',formatter:linkNumberFormatter0},
	                {field:'appType',title:'신청종류',width:50,align:'center'},
	                {field:'fees',title:'대행수수료',width:80,align:'center'},
	                {field:'upload',title:'업로드',width:50,align:'center'},
	                {field:'billYn',title:'계산서발행여부',width:60,align:'center'},
	                {field:'billDate',title:'발행일자',width:80,align:'center'},
		        ]],
