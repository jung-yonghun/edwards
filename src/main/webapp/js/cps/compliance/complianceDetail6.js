		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'bb',title:'신청일',width:80,align:'center'},
	                {field:'cc',title:'발급일',width:80,align:'center'},
	                {field:'dd',title:'접수번호',width:100,align:'center'},
	                {field:'ee',title:'승인번호',width:100,align:'center'},
	                {field:'ff',title:'B/L No.',width:50,align:'center'},
	                {field:'gg',title:'자재코드',width:100,align:'center'},
	                {field:'hh',title:'모델명',width:100,align:'center'},
	                {field:'ii',title:'수입국',width:100,align:'center'},
	                {field:'jj',title:'HS CODE',width:200,align:'center'},
	                {field:'kk',title:'용도',width:100,align:'center'},
	                {field:'ll',title:'연간수입 예정량(KG)',width:100,align:'center'},
	                {field:'mm',title:'제공자',width:80,align:'center'},
	                {field:'nn',title:'확인서류 제공자',width:50,align:'center'},
	                {field:'oo',title:'근거서류',width:50,align:'center'},
	                {field:'pp',title:'기존물질',width:80,align:'center'},
	                {field:'qq',title:'등록대상 기존물질',width:80,align:'center'},
	                {field:'rr',title:'신규물질',width:80,align:'center'},
	                {field:'ss',title:'유독물질',width:80,align:'center'},
	                {field:'tt',title:'허가물질',width:80,align:'center'},
	                {field:'uu',title:'제한물질',width:80,align:'center'},
	                {field:'vv',title:'금지물질',width:80,align:'center'},
	                {field:'ww',title:'사고대비물질',width:80,align:'center'},
	                {field:'xx',title:'대행수수료(VAT별도)',width:80,align:'center'},
	                {field:'yy',title:'업로드',width:50,align:'center'},
	                {field:'zz',title:'계산서발행여부',width:60,align:'center'},
	                {field:'aaa',title:'발행일자',width:80,align:'center'},
		        ]],
