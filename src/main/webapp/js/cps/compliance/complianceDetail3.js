		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'dd',title:'B/L No.',width:100,align:'center'},
	                {field:'ee',title:'자재코드',width:100,align:'center'},
	                {field:'ff',title:'수량',width:50,align:'center'},
	                {field:'gg',title:'품목',width:100,align:'center'},
	                {field:'hh',title:'모델명(신고서)',width:100,align:'center'},
	                {field:'ii',title:'모델구분',width:100,align:'center'},
	                {field:'jj',title:'SUPPLIER정보',width:100,align:'center'},
	                {field:'kk',title:'사용연령',width:60,align:'center'},
	                {field:'ll',title:'제조사명',width:100,align:'center'},
	                {field:'mm',title:'제조사 주소',width:200,align:'center'},
	                {field:'nn',title:'제조국명',width:100,align:'center'},
	                {field:'oo',title:'주요재질',width:100,align:'center'},
	                {field:'pp',title:'크기/한계체중',width:60,align:'center'},
	                {field:'qq',title:'HS CODE',width:70,align:'center'},
	                {field:'rr',title:'시험결과',width:40,align:'center'},
	                {field:'ss',title:'검사비용(Vat별도)',width:60,align:'center'},
	                {field:'tt',title:'컨설팅비용',width:60,align:'center'},
	                {field:'uu',title:'업로드',width:40,align:'center'},
	                {field:'vv',title:'계산서 발생여부',width:40,align:'center'},
	                {field:'ww',title:'발행일자',width:40,align:'center'},
		        ]],
