		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'ff',title:'품명',width:50,align:'center'},
	                {field:'gg',title:'모델명',width:100,align:'center'},
	                {field:'hh',title:'수량',width:100,align:'center'},
	                {field:'ii',title:'발송처',width:100,align:'center'},
	                {field:'jj',title:'담당자',width:200,align:'center'},
	                {field:'kk',title:'발급번호',width:100,align:'center'},
	                {field:'ll',title:'거래처',width:100,align:'center'},
	                {field:'mm',title:'거래국',width:80,align:'center'},
	                {field:'nn',title:'거래업체담당자',width:50,align:'center'},
	                {field:'oo',title:'거래업체전화번호',width:50,align:'center'},
	                {field:'pp',title:'통관진행',width:80,align:'center'},
	                {field:'11',title:'대행수수료',width:80,align:'center'},
	                {field:'rr',title:'업로드',width:50,align:'center'},
	                {field:'ss',title:'계산서발행여부',width:60,align:'center'},
	                {field:'tt',title:'발행일자',width:80,align:'center'},
		        ]],
