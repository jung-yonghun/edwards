		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'aa',title:'업체명',width:200,align:'center'},
	                {field:'bb',title:'Phase',width:80,align:'center'},
	                {field:'cc',title:'MATLOCAL',width:80,align:'center'},
	                {field:'dd',title:'MATLOCAL2',width:100,align:'center'},
	                {field:'ee',title:'Material Descri',width:100,align:'center'},
	                {field:'ff',title:'HPG',width:50,align:'center'},
	                {field:'gg',title:'HPG Description',width:100,align:'center'},
	                {field:'hh',title:'Category',width:100,align:'center'},
	                {field:'ii',title:'등록가능',width:100,align:'center'},
	                {field:'jj',title:'차종',width:200,align:'center'},
	                {field:'kk',title:'Brand',width:100,align:'center'},
	                {field:'ll',title:'Regulation',width:100,align:'center'},
	                {field:'mm',title:'SLS 확인',width:80,align:'center'},
	                {field:'nn',title:'최초부품제작자',width:50,align:'center'},
	                {field:'oo',title:'창유리:위치/재질 휠:재질',width:50,align:'center'},
	                {field:'pp',title:'원산지',width:80,align:'center'},
	                {field:'qq',title:'D-Chain',width:80,align:'center'},
	                {field:'rr',title:'Sticker',width:80,align:'center'},
	                {field:'ss',title:'요청년월',width:80,align:'center'},
	                {field:'tt',title:'등록년월',width:80,align:'center'},
	                {field:'uu',title:'승인년월',width:80,align:'center'},
	                {field:'vv',title:'등록승인완료',width:80,align:'center'},
	                {field:'ww',title:'제원관리번호',width:80,align:'center'},
	                {field:'xx',title:'On HandStk',width:80,align:'center'},
	                {field:'yy',title:'ABSAA',width:80,align:'center'},
	                {field:'zz',title:'DSFC',width:80,align:'center'},
	                {field:'aaa',title:'Indicator/D-Chain',width:80,align:'center'},
	                {field:'bbb',title:'Multi Code',width:80,align:'center'},
	                {field:'ccc',title:'사진촬영요청',width:80,align:'center'},
	                {field:'ddd',title:'사진수령완료',width:80,align:'center'},
	                {field:'eee',title:'업로드',width:50,align:'center'},
	                {field:'fff',title:'계산서발행여부',width:60,align:'center'},
	                {field:'ggg',title:'발행일자',width:80,align:'center'},
		        ]],
