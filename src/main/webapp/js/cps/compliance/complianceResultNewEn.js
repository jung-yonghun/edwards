...
$(document).ready(function(){
	if(isEmpty($('#ID').val())){
		...
		setTimeout(function(){
		$('#masterGrid').datagrid({
			title			: 'Requirement/Certification Status',
			width			: '100%',
			height			: '340px',
			rownumbers		: true,
			singleSelect	: true,
			...
			view			: bufferview,
			columns			: [[
                {field:'RealSangho',title:'Owner',width:200},
                {field:'ComSangho',title:'Importer',width:200},
                {field:'BlNo',title:'B/L No',width:120},
                {field:'DocuGbn',title:'Requirement/Certification',width:250},
                {field:'SendNo',title:'Application No.',width:120,align:'center',formatter:linkNoFormatter},
                {field:'IssueDtm',title:'Applied Date',width:80,align:'center',formatter:linkDateFormatter},
                {field:'Status',title:'Status',width:80},
                {field:'IssueNo',title:'Approval No.',width:130,align:'center'},
                {field:'Etc01',title:'Issued Date',width:80,align:'center',formatter:linkDateFormatter},
                {field:'MrnNo',title:'Cargo Management No.',width:130},
                {field:'SenderSangho',title:'Supplier',width:200},
                {field:'Su',title:'Total Qty',width:50,align:'center'},
                {field:'c',title:'Service Rate',width:80,align:'center'},
                {field:'d',title:'Service Charge',width:80,align:'center'},
                {field:'e',title:'Tax Invoice Issuance',width:80,align:'center'},
		...
		$('#excelGrid').datagrid({
			...
			height	: _setHeight,
			columns	: [[
			    {field:'DocuGbn',title:'Documents'},
                {field:'Status',title:'Status'},
                {field:'ComSangho',title:'Importer'},
                {field:'BlNo',title:'B/L No'},
                {field:'SendNo',title:'Application No.'},
                {field:'IssueDtm',title:'Applied Date'},
                {field:'IssueNo',title:'Approval No.'},
                ...
                {field:'a',title:'Etc'},
                {field:'b',title:'Total Qty'},
                {field:'c',title:'Service Rate'},
                {field:'d',title:'Service Charge'},
                {field:'e',title:'Tax Invoice Issuance'}
	        ]]
		});

		$('#detailGrid').datagrid({
			title			: 'Requirement/Certification Status in Detail',
			width			: '100%',
			height			: '200px',
			rownumbers		: true,
			singleSelect	: true,
			...
			view			: bufferview,
			columns			: [[
	            {field:'a',title:'Select from Above',width:500}
	        ]]
		});
