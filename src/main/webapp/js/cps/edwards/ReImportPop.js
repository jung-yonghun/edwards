	...
	if(isEmpty($('#ID').val())){
		...
		$('#masterGrid').datagrid({
			...
			columns			: [[
				...
				{field:'KEY_ED_REEXPT_MASTER',title:'KEY_ED_REEXPT_MASTER',hidden:true}
	        ]],
...
function fn_bindData(d){
	...
	$("#addForm1 #KEY_ED_REEXPT_MASTER").val(d.KEY_ED_REEXPT_MASTER);
}
...
//				if($("#addForm1 #IMPT_ORDR_MNG_NO").val()!="" || $("#addForm1 #IMPT_ORDR_MNG_NO").val()!=null){
