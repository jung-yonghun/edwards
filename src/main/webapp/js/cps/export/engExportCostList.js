...
$(document).ready(function(){
	if(isEmpty($('#ID').val())){
		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'SURI_DT',title:'D. Acceptance',width:80,align:'center',formatter:linkDateFormatter},
	                {field:'SUPLY_NM',title:'Buyer',width:200},
	                {field:'HAWB',title:'Invoice No.',width:120},
	                {field:'FULLSINGONO',title:'Declaration No.',width:120,align:'center',formatter:linkExSingoFormatter},
	                {field:'DEAL_PUM_NM',title:'Description',width:200},
	                {field:'SINGO_EK',title:'Value($)',width:80,align:'right',formatter:linkNumberFormatter0},
	                {field:'GAMGA_EK',title:'Value(￦)',width:80,align:'right',formatter:linkNumberFormatter0},
	                {field:'TOT_QT',title:'Package Qty',width:50,align:'right',formatter:linkNumberFormatter0},
	                {field:'QT_UNIT',title:'Unit(Package)',width:50,align:'center'},
	                {field:'TOT_WT',title:'Weight',width:80,align:'right',formatter:linkNumberFormatter3},
	                {field:'JINGSU_TP',title:'Type of collection',width:50,align:'center'},
	                {field:'INDO_JOGUN',title:'Incoterms',width:50,align:'center'},
	                {field:'PAY_METHOD',title:'Type of payment',width:50,align:'center'},
	                {field:'MONEY_EK',title:'Total Value',width:80,align:'right',formatter:linkNumberFormatter0},
	                {field:'MONEY_CD',title:'Currency',width:50,align:'center'},
	                {field:'EXCH_RATE',title:'Exchange rate',width:80,align:'right'},
	                {field:'SINGO_DT',title:'D. Declaration',width:80,align:'center',formatter:linkDateFormatter},
	                {field:'JAEWON_CD',title:'Source of clearance',width:40,align:'center'},
	                {field:'SEGWAN',title:'Customshouse',width:40,align:'center'},
	                {field:'GWA',title:'Section',width:40,align:'center'},
	                {field:'FILE_NO1',title:'FILE NO1',width:120},
	                {field:'FILE_NO2',title:'FILE NO2',width:120},
	                {field:'CUS_BUHO',title:'CUS_BUHO',hidden:true},
			...
			$('#excelGrid').datagrid({
				...
				height	: _setHeight,
				columns	: [[
	                {field:'SURI_DT',title:'D. Acceptance'},
	                {field:'SUPLY_NM',title:'Buyer'},
	                {field:'HAWB',title:'B/L No.',width:120},
	                {field:'FULLSINGONO',title:'Declaration No.'},
	                {field:'DEAL_PUM_NM',title:'Description'},
	                {field:'SINGO_EK',title:'Value($)'},
	                {field:'GAMGA_EK',title:'Value(￦)'},
	                {field:'TOT_QT',title:'Package Qty'},
	                {field:'QT_UNIT',title:'Unit(Package)'},
	                {field:'TOT_WT',title:'Weight',width:80},
	                {field:'JINGSU_TP',title:'Type of collection'},
	                {field:'INDO_JOGUN',title:'Incoterms'},
	                {field:'PAY_METHOD',title:'Type of payment'},
	                {field:'MONEY_EK',title:'Total Value'},
	                {field:'MONEY_CD',title:'Currency'},
	                {field:'EXCH_RATE',title:'Exchange rate'},
	                {field:'SINGO_DT',title:'D. Declaration'},
	                {field:'JAEWON_CD',title:'Source of clearance'},
	                {field:'SEGWAN',title:'Customshouse'},
	                {field:'GWA',title:'Section'},
			...
			$('#fileGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'b',title:'Delete',width:40,align:'center',formatter:linkDelFormatter}
		        ]]
			});
		...
		if($('#ID').val()=="258"){
			$('#strFromDate').val("20170518");
			$('#strToDate').val("20170525");
		}else if($('#ID').val()=="156"){
			$('#strFromDate').val("20150101");
			$('#strToDate').val("20161231");
		}else{
...
var fn_searchExcel = function(){
	if(($('#USERGRADE').val()=="A" || $('#USERGRADE').val()=="B") || $('#ID').val()=="156"){
		exportCsv("../apis/customs/selectAccountCostCustomsList", $("#frm1").serializeObject(), $('#excelGrid'),"expoAccount");
	}else{
		var status = 0;
