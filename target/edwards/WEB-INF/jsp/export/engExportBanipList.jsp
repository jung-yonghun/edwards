...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/engExportBanipList.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:90px">
						  ...
						  <option value="ban1VerifyDate">D. Acceptance</option>
						  <option value="ban1WrkDate" selected="selected">D. Write</option>
						</select>
					  </td>
					  <td>
