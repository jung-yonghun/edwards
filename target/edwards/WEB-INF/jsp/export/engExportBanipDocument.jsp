...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/engExportBanipDocument.js'/>"></script>
	<style>
	    .custom-statusbar {
		    ...
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:775px">
			      ...
			      <div class="normal_Button">
				  	<a href="javascript:fn_shipDocu(0);">ALL</a>
				  	<a href="javascript:fn_shipDocu(1);">Shipping</a>
				  	<a href="javascript:fn_shipDocu(2);">Clearance</a>
				  	<a href="javascript:fn_shipDocu(3);">Delivery</a>
				  	<a href="javascript:fn_shipDocu(4);">Settle</a>
				   	<a href="javascript:fn_shipDocu(5);">Other</a>
				  </div>
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					      ...
					      <select id="_DateType" name="_DateType" style="width:90px">
					        <option value="ban1JubsuDate">D. Receiving</option>
						    <option value="ban1VerifyDate" selected="selected">D. Acceptance</option>
						    <option value="ban1WrkDate">D. Write</option>
						  </select>
					  	</td>
					  	<td>
