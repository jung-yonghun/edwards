...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/engExportRequestIns.js'/>"></script>
    <style>
        #drop {
		  	  ...
		  	  <div class="easyui-tabs" data-options="fit:true,plain:true">
		  	    <div title="Type 1" style="padding:10px;">
		  	      <div class="normal_Button">
				 	<a href="javascript:fn_saveAction('insert');">Save</a>
			      ...
			      <div style="margin-bottom:7px;">
					 * Download the sample below and register Excel as B / L No in batch.
				  </div>
			      ...
			      <script>
				    ...
				    function process_wb(wb) {
			        	...
			        	for(var i = 0; i < aabb.length; i++){
			        		if (aabb[i].Inv번호 != undefined){
				        		...
				        		aabb[i].startCompensationYn 	= aabb[i].유무상;
				        		aabb[i].startLocation 			= aabb[i].물품소재지;
				        		aacc.push(aabb[i]);
			                }
					...
					<div class="normal_Button">
				      <a href="javascript:fn_sampleAction();">Download Sample</a>
				      <a href="javascript:fn_updateAction();">Save</a>
		  	    ...
		  	    <div title="Type 3" style="padding:10px;">
		  	      * B/L Info, Invoice Info, PackingList Info systematically linked (I / F)<br>
