...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/export/exportOriginList.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:60px">
						  ...
						  <option value="Expo_singo_date_Day">신고일</option>
						  <option value="Expo_ok_date_Day" selected="selected">수리일</option>
						</select>
					  </td>
					  <td>
					...
					<tr height="23px">
					  ...
					  <td>
					    <select id="expoLoadedYn" name="expoLoadedYn" style="width:60px">
					      <option value="">전체</option>
					      <option value="Y">선적</option>
						  <option value="N" >미선적</option>
						</select>
					  </td>
					</tr>
				  </table>
