...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceResultHm.js'/>"></script>
  </head>
  <body>
		    ...
		    <div class="container">
			  <div class="normal_cont">
				<div class="normal_Top">
				  ...
				  <input type="hidden" id="RqGbn" 			name="RqGbn" 			value="HM">
				  <table width="100%">
				  	<col width="06%" />
				  	<col width="27%" />
				  	<col width="01%" />
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:60px">
					      <option value="IssueDtm" selected>신청일자</option>
						</select>
					  </td>
					  <td>
					  ...
					  <td></td>
					  <td>관리번호</td>
					  <td><input type="text" id="SendNo" name="SendNo" onkeypress="keyDown()"/></td>
					</tr>
				  </table>
				  </form>
				</div>
