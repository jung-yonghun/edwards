...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceDetail2.js'/>"></script>
		    ...
		    <div class="container">
			  <div class="normal_cont">
				<div class="normal_Top">
				  ...
				  <input type="hidden" id="gubun" 		name="gubun" 		value="전파">
				  <table width="100%">
				  	<col width="06%" />
				  	<col width="28%" />
				  	<col width="01%" />
					...
					<tr height="23px">
					  ...
					  <td></td>
					  <td>HS CODE</td>
					  <td><input type="text" id="hsCode" name="hsCode" onkeypress="keyDown()"/></td>
					  <td></td>
					  <td>자재코드</td>
					...
					<tr height="23px">
					  ...
					  <td></td>
					  <td>요건항목</td>
					  <td><input type="text" id="yogTitle" name="yogTitle" onkeypress="keyDown()"/></td>
					  <td></td>
					  <td>제조국명</td>
					  <td><input type="text" id="productNation" name="productNation" onkeypress="keyDown()"/></td>
					</tr>
				  </table>
				  </form>
				</div>
				<div class="normal_Button">
				  ...
				  <a href="javascript:fn_excelAction();"><img src="<c:url value='/images/cps/normal_docu.png'/>"></a>
				</div>
				<div class="easyui-layout" style="width:100%;height:600px">
		    	  ...
		    	  <div data-options="region:'center',split:true" style="width:50%;height:250px;box-sizing:border-box;border:0px;overflow:hidden;">
		  	        <div class="hsnew_C02_table" style="margin-left:-10px;margin-top:-10px;margin-bottom:-10px;">
			  		  <table>
		   	    	  	<col width="10%"/>
                      	<col width="90%"/>
                      	<tr>
                          <td class="left">
                          	제품정보<a href="javascript:pop()"><img src="../images/cps/hs_seach.png" id="customerSearch" width="8"></a>
                          </td>
                          <td>
                            <div class="easyui-texteditor" id="contents1" style="width:100%;height:230px;"></div>
                          </td>
                      	</tr>
                      </table>
                  	</div>
		    	  ...
		    	  <div data-options="region:'east',split:true" style="width:50%;height:250px;box-sizing:border-box;border:0px">
		    	    <div class="easyui-tabs" data-options="fit:true,plain:true">
		    	      <div title="통관현황" style="padding:10px;">
			  	        <div class="normal_con01">
