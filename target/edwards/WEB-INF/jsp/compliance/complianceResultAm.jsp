...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceResultAm.js'/>"></script>
  </head>
  <body>
		    ...
		    <div class="container">
			  <div class="normal_cont">
				<div class="normal_Top">
				  ...
				  <input type="hidden" id="RqGbn" 			name="RqGbn" 			value="AM">
				  <table width="100%">
				  	<col width="06%" />
				  	<col width="27%" />
				  	<col width="01%" />
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:60px">
					      ...
					      <option value="ProcessDtm" selected>처리일</option>
						</select>
					  </td>
					  <td>
