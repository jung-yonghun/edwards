...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/compliance/complianceDetail7.js'/>"></script>
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:60px">
                          ...
                          <option value="compDt">인증일</option>
						</select>
					  </td>
					  <td>
					  ...
					  <td></td>
					  <td>인증번호</td>
					  <td><input type="text" id="compNum" name="compNum" onkeypress="keyDown()"/></td>
					</tr>
					<tr height="23px">
					  <td>업체명</td>
