...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/import/importWarehousePop.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
			  ...
			  <div class="normal_cont">
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0" border="1" align="center" style="border-collapse:collapse; border:1px black solid;">
				  <tr style="height:50px;font-size:14pt">
				    <td style="width:10%;text-align:center;background-color:#ecf7fd;color:black;cursor:pointer" onclick="javascript:location.reload();">총건수</td>
				    <td style="width:10%;text-align:center;color:black;" id="total"></td>
				    <td style="width:10%;text-align:center;background-color:#ecf7fd;color:black;cursor:pointer" onclick="javascript:fastNext();">Page</td>
                ...
                <thead>
                  <tr style="height:50px;text-align:center;background-color:#eeeeee;color:black;font-size:14pt">
                    <th>편명</th>
                    <th>MAWB</th>
                    <th>HBL</th>
                    <th>입항일자</th>
