...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/import/importCostList.js'/>"></script>
	<style>
	    .custom-statusbar {
		  ...
		  <div class="right1">
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:775px">
			  	<div data-options="region:'east',split:true" style="width:400px;box-sizing:border-box;border:0px;padding:0px;">
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					      ...
					      <select id="_DateType" name="_DateType" style="width:60px">
						  	<option value="Singo_date_Day">신고일</option>
						  	<option value="Ok_date_Day" selected="selected">수리일</option>
						  </select>
					  	</td>
					  	<td>
					  	...
					  	<td></td>
					  	<td>납세자상호</td>
					  	<td><input type="text" id="napseSangho" name="napseSangho" onkeypress="keyDown()"/></td>
					  	<td></td>
					  </tr>
					  <tr height="23px">
					  	<td>B/L No.</td>
