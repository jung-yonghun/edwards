...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
    ...
    <title>수입통관의뢰 수정</title>
	<jsp:include page="/WEB-INF/jsp/include/head_titleCss.jsp"></jsp:include>
	<jsp:include page="/WEB-INF/jsp/include/head_titleJs.jsp"></jsp:include>
	<script type="text/javascript" src="<c:url value='/js/cps/import/importRequestMod.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		    ...
		    <div class="easyui-layout" style="width:550px;height:400px">
		      <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
	  	       	<div class="normal_Button">
	  	       	  <a href="javascript:fn_saveAction('mailTransfer');">메일</a>
