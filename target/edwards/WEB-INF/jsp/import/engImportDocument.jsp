...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/import/engImportDocument.js'/>"></script>
				  ...
				  <div class="normal_Top">
				    ...
				    <input type="hidden" id="forwarder" 	name="forwarder">
					  ...
					  <tr height="23px">
					  	...
					  	<td></td>
					  	<td>Reference No</td>
					  	<td><input type="text" id="chamjoNo" name="chamjoNo" onkeypress="keyDown()"/></td>
					  </tr>
				  	</table>
				  	</form>
				  </div>
