...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/orgOrdrMaster.js?20231227'/>"></script>
	<style>
        #drop {
    ...
    <div id="wrap">
	  <div id="content">
		<div class="cont_con ovH">
		  <div class="right1">
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:785px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:360px">
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:32px;margin-top:32px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <div class="hsnew_C02_table" style="margin-top:-10px">
				  	  ...
				  	  <input type="hidden" id="KEY_ED_REFUND_ORG_ORDR" 	name="KEY_ED_REFUND_ORG_ORDR">
				  	  <input type="hidden" id="REFUND_ORDR_MNG_NO" 		name="REFUND_ORDR_MNG_NO">
			  		  <table>
		   	    	  	<col width="20%"/>
                      	<col width="80%"/>
                      	<col width="23%"/>
						...
						<tr>
                          <td class="left">신고기한일</td>
                          <td><input type="text" id="DECL_DDAY" name="DECL_DDAY" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
                      	</tr>
                      	<tr>
                          <td class="left">신고업체</td>
                          <td>
                            <input type="text" id="DECL_CUSTOMS_CD" name="DECL_CUSTOMS_CD" style="display:none"/>
                            <input type="text" id="DECL_CUSTOMS_NM" name="DECL_CUSTOMS_NM" style="width:100%"/>
                          </td>
                      	</tr>
                      	<tr>
                          <td class="left">신고담당사원</td>
                          <td><input type="text" id="DECL_DIVS_MAN" name="DECL_DIVS_MAN" style="width:100%"/></td>
                      	</tr>
                      	<tr>
			  	...
			  	<div class="easyui-tabs" id="tabs" data-options="fit:true,plain:true" style="height:410px;">
		    	  <div title="원상태 환급신청내역" style="padding-left:10px;padding-right:10px">
				    ...
				    <form id="addForm1" name="addForm1">
				  	  ...
				  	  <input type="hidden" id="HS_CD" 				name="HS_CD">
				  	</form>
