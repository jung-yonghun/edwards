...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/bomDrawIns.js?20231227'/>"></script>
	<style type="text/css">
	  .custom-statusbar {
			      ...
			      <div class="easyui-layout" style="width:100%;height:745px">
				    <div data-options="region:'north',split:true" style="width:100%;height:745px;box-sizing:border-box;border:0px">
					  <div class="normal_Top">
					    ...
					    <input type="hidden" id="KEY_ED_BOM_DRAW" 	name="KEY_ED_BOM_DRAW">
					  	<table width="100%">
					  	  <col width="08%" />
					  	  <col width="42%" />
					  	  <col width="02%" />
						    ...
						    <td style="vertical-align:baseline">
	                            ...
	                            <option value="JEPUM_CD">제품코드</option>
	                            <option value="RgCode">모품목코드</option>
						  	...
						  	<td></td>
						  	<td>시작일</td>
						  	<td><input type="text" id="FrDay" name="FrDay" onkeypress="keyDown()" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
						  </tr>
					  	</table>
					  	</form>
					  </div>
					  ...
					  <!-- form name="excelUpForm" id="excelUpForm" enctype="multipart/form-data" method="POST" action="../apis/edwardsUpload/excelUp">
