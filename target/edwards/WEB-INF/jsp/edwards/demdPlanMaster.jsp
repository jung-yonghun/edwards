...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/demdPlanMaster.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		    ...
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:735px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:330px">
			  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:47px;margin-top:47px;">
		    	    ...
		    	    <div title="일반등록">
		    	      ...
		    	      <div class="hsnew_C02_table" style="margin-top:-10px">
				  	  ...
				  	  <input type="hidden" id="KEY_ED_EXEM_DEMD_PLAN" 	name="KEY_ED_EXEM_DEMD_PLAN">
				  	  <input type="hidden" id="EXEM_PLAN_MNG_NO" 		name="EXEM_PLAN_MNG_NO">
			  		  <table>
		   	    	  	<col width="20%"/>
                      	<col width="80%"/>
                      	<col width="23%"/>
                      	...
                      	<tr>
                          <td class="left">계획년도/월</td>
                          <td>
                            <select id="PLAN_YY" name="PLAN_YY" style="width:60px;">
                            ...
                            <select id="PLAN_MM" name="PLAN_MM" style="width:60px;">
                              <option value="">선택</option>
                      	...
                      	<tr>
                          <td class="left">적용일/종료일</td>
                          <td>
                            <input type="text" id="APLY_STRT_DT" name="APLY_STRT_DT" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/>
                            <input type="text" id="APLY_END_DT"  name="APLY_END_DT"  style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/>
                          </td>
                      	</tr>
                      	<tr>
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					  	<td>계획년도/월</td>
					  	<td>
					  	  <select id="PLAN_YY1" name="PLAN_YY1" style="width:60px;">
                              <option value="">선택</option>
                              <option value="2019">2019</option>
					  	  ...
					  	  <select id="PLAN_MM1" name="PLAN_MM1" style="width:60px;">
                              <option value="">선택</option>
                              <option value="01">01</option>
                              <option value="02">02</option>
                              <option value="03">03</option>
					  ...
					  <tr height="23px">
					  	<td>시작일자</td>
					  	<td><input type="text" id="APLY_STRT_DT1" name="APLY_STRT_DT1" onkeypress="keyDown()" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/></td>
					  	<td></td>
					  	<td>진행상태</td>
					  	<td>
		    	  ...
		    	  <div title="감면수요계획정보" style="padding-left:10px;padding-right:10px">
				    <div class="easyui-layout" style="width:100%;height:350px">
				  	<div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px;padding-top:3px;margin-top:3px;">
				  	  ...
				  	  <form id="addForm1" name="addForm1">
					  	  <input type="hidden" id="ID" 							name="ID" 				value="${sessionScope.ID}">
					  	  <input type="hidden" id="KEY_ED_EXEM_DEMD_PLAN_PROD" 	name="KEY_ED_EXEM_DEMD_PLAN_PROD">
					  	  <input type="hidden" id="EXEM_PLAN_MNG_NO" 			name="EXEM_PLAN_MNG_NO">
					  	  <input type="hidden" id="PLAN_PROD_SEQNO" 			name="PLAN_PROD_SEQNO">
					  	  <input type="hidden" id="GRP_COMP_CD" 				name="GRP_COMP_CD">
					  </form>
			    	    ...
			    	    <div title="엑셀등록" style="padding:10px">
					      ...
					      <script>
						    ...
						    function process_wb(wb) {
						        ...
						        var aabb = JSON.parse(output).demdMasterCode;
						        var aacc = new Array();

					        	for(var i = 0; i < aabb.length; i++){
					        		aabb[i].PROD_CD 		= aabb[i].제품코드;
