...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/hsSearch.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		  ...
		  <div class="right1">
			<div class="normal_Top">
			  ...
			  <table width="450px">
				...
				<tr height="23px">
				  <td>세번부호</td>
				  <td><input type="text" id="hscode" name="hscode" onkeypress="keyDown()" value="${param.hscode}"/></td>
				</tr>
			  </table>
			</div>
