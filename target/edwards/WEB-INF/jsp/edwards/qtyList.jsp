...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/qtyList.js?20231227'/>"></script>
	<style type="text/css">
		  ...
		  <div class="right1">
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:735px">
			    ...
			    <div data-options="region:'north',split:true" style="width:100%;height:110px;box-sizing:border-box;border:0px">
				  ...
				  <font color="red" style="margin-left:10pt">엑셀 업로드시 주의 : 서식 지우고 올리기(따옴표제거), 란/행은 텍스트형식으로 (001/01),  잔량 변경이 있는 경우에만 적용되고 Log에 쌓임.</font>
			  	</div>
