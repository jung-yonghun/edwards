...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/ReImportPop1.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
			  ...
			  <div class="easyui-layout" style="width:100%;height:600px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:380px">
				  ...
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					  	<td>면제번호</td>
					  	<td><input type="text" id="ExEmNo" name="ExEmNo" onkeypress="keyDown()"/></td>
					  	<td></td>
					  	<td>SO No</td>
					  	<td><input type="text" id="SoNo" name="SoNo" onkeypress="keyDown()"/></td>
					  	<td></td>
					  	<td>Item Code</td>
					  	<td><input type="text" id="PROD_CD" name="PROD_CD" onkeypress="keyDown()" value="${param.PROD_CD}"/></td>
					  </tr>
				  	</table>
				  </div>
			  	...
			  	<div data-options="region:'center',split:true" style="width:100%;box-sizing:border-box;border:0px">
				    <div class="easyui-layout" style="width:100%;height:200px">
					  ...
					  <input type="hidden" id="ID" 						name="ID" 					value="${sessionScope.ID}">
			  	      ...
			  	      <input type="hidden" id="ExEmNo" 					name="ExEmNo">
			  	      <input type="hidden" id="SoNo" 					name="SoNo">
			  	      <input type="hidden" id="EndUserName" 			name="EndUserName">
			  	      <input type="hidden" id="IMPT_QTYORI" 			name="IMPT_QTYORI">
			  	      <input type="hidden" id="BL_NO" 					name="BL_NO">
			  	      <input type="hidden" id="ORIG_STAT_OBJ" 			name="ORIG_STAT_OBJ"		value="${param.ORIG_STAT_OBJ}">
