...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/exportDrawCheck4.js?250217'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
			  ...
			  <div class="easyui-layout" style="width:100%;height:700px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:680px">
		      	<div data-options="region:'center'" style="width:100%;box-sizing:border-box;border:0px">
		      	  #관세환급 조정고시 별표 1 + 별표2 중 다중 세율적용 해당하는 아이템입니다. 계산을 진행하시면 다음 계산화면이 나타납니다.<br>
		      	  <input type="hidden" id="ID" 					name="ID" 				value="${sessionScope.ID}">
		      	  <input type="hidden" id="taxNum" 				name="taxNum" 			value="${sessionScope.TAXNO}">
		      	  <input type="hidden" id="userNm" 				name="userNm" 			value="${sessionScope.USERNAME}">
		      	  <input type="hidden" id="EXPT_ORDR_MNG_NO" 	name="EXPT_ORDR_MNG_NO" value="${param.EXPT_ORDR_MNG_NO}">
		      	  <input type="hidden" id="3month" 				name="3month">
