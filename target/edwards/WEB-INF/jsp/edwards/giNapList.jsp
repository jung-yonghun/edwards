...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/giNapList.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		  ...
		  <div class="right1">
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:735px">
			    ...
			    <div data-options="region:'center',split:true" style="width:100%;height:720px;box-sizing:border-box;border:0px">
				  <div class="normal_Top">
					  ...
					  <tr height="23px">
					  	<td>제품코드(기납원상태)</td>
					  	<td><input type="text" id="JpCode" name="JpCode" onkeypress="keyDown()"/></td>
					  	<td></td>
					  	<td>자재코드</td>
