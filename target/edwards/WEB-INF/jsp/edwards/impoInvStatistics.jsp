...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/impoInvStatistics.js?20231227'/>"></script>
	<style type="text/css">
	  .custom-statusbar {
			  ...
			  <div class="easyui-layout" style="width:100%;height:735px">
			    ...
			    <div class="easyui-layout" style="width:100%;height:130px">
			  	...
			  	<div class="easyui-tabs" id="tabs" data-options="fit:true,plain:true" style="height:530px;">
			  	  <div title="수입 Invoice 내역" style="padding-left:10px;padding-right:10px">
				  ...
				  <div title="Express Invoice 내역" style="padding-left:10px;padding-right:10px">
				    <div class="easyui-layout" style="width:100%;height:560px">
			      	<div data-options="region:'center'" style="width:100%;box-sizing:border-box;border:0px">
			      	  <div class="normal_Button" style="margin-left:5px;">
			      	  ...
			      	  <div class="normal_con01" id='parentDiv20' style="padding-left:5px;padding-right:5px">
