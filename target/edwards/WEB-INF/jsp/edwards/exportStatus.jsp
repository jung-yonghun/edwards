...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/exportStatus.js?250718'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		    ...
		    <div class="container">
			  <div class="normal_cont">
				...
				<div class="easyui-layout" style="width:100%;height:620px">
		    	  ...
		    	  <div data-options="region:'center',split:true" style="width:50%;height:250px;box-sizing:border-box;border:0px">
		    	    <div class="normal_con01">
