...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/deadLineList.js?250619'/>"></script>
	<style type="text/css">
				...
				<div class="easyui-tabs" id="tabs" data-options="fit:true,plain:true" style="width:100%;height:760px">
		          ...
		          <div title="재수출" style="padding:10px;">
					...
					<div class="normal_Button">
					  ...
					  <a href="javascript:fn_addAction();">추가등록</a>
		          ...
		          <div title="FTA사후관리(수입)" style="padding:10px;">
					  ...
					  <table width="100%">
						...
						<tr height="23px">
						  ...
						  <td>구분</td>
						  <td>
						    <select id="impoFtaObj" name="impoFtaObj" style="width:100px">
						      <option value="">전체</option>
						      <option value="확인" selected>미적용</option>
						      <option value="공백">미적용 공백만</option>
		          ...
		          <div title="수출정정관리" style="padding:10px;">
					...
					<table width="100%">
					  ...
					  <tr>
						...
						<td>
						  <div class="normal_Button">
					  		<a href="javascript:fn_codeExcel7();"><img src="<c:url value='/images/cps/normal_docu.png'/>"></a>
						  </div>
						  <div class="normal_con01">
						    <table id="detailGrid64"></table>
						  </div>
						</td>
						<td></td>
						<td>
