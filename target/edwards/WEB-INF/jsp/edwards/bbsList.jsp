...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/edwards/bbsList.js?20231227'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		  ...
		  <div class="right1">
		    <div class="container">
			  <div class="easyui-layout" style="width:100%;height:775px">
			      ...
			      <input type="hidden" id="_dateType" 	name="_dateType" 	value="finishedDay"/>
			  	  <table width="100%">
			  	  <col width="10%" />
			  	  <col width="39%" />
			  	  <col width="01%" />
				  ...
				  <tr height="23px">
				  	<td>등록일</td>
				  	<td>
				  	  <input type="text" id="startDay" name="startDay" onkeypress="keyDown()" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/> ~
				  	  <input type="text" id="endDay" name="endDay" onkeypress="keyDown()" style="width:70px;cursor:pointer;text-align:center;" maxlength="8"/>
				  	</td>
				  	<td></td>
				  	<td>내용</td>
