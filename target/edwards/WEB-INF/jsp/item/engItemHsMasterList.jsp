...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/engItemHsMasterList.js'/>"></script>
	<style>
    .custom-statusbar {
					...
					<tr height="23px">
					  <td>
					    <select id="_DateType" name="_DateType" style="width:90px">
					      <option value="hsRegDt">D. Uploading</option>
                          <option value="hsReviewDt">D. Reviewed</option>
                          <option value="itemOkDtm">D. Confirmed</option>
						</select>
					  </td>
					  <td>
			  	      ...
			  	      <div title="Opinion">
			  	        <div class="hsnew_C02_table">
				  		  ...
				  		  <table>
	                      	...
	                      	<col width="91%"/>
	                      	<tr>
	                          <td class="left">Confirmation opinion</td>
	                          <td>
	                      	...
	                      	<tr>
	                          <td class="left">Revising Request</td>
	                          <td>
			  	      ...
			  	      <div title="Detail">
			  	        <div class="hsnew_C02_table">
				  		  ...
				  		  <table>
	                      	...
	                      	<tr>
	                          <td class="left">model/specification</td>
	                          <td colspan="5">
		    	    ...
		    	    <div class="easyui-tabs" data-options="fit:true,plain:true">
			  	      <div title="Attachments" style="padding:10px;">
			              ...
			              <div data-options="region:'east',split:true" style="width:40%;box-sizing:border-box;border:0px">
                        	...
                        	<div id="fileuploader" style="width:150px">File Search</div>
                    		</form>
			              </div>
			            </div>
			  	      </div>
