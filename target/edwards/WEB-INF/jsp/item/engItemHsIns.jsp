...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/engItemHsIns.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
				...
				<div class="hsnew_C02_table">
				  ...
				  <table>
                    ...
                    <tr>
                      ...
                      <td colspan="5">
                        <input type="text" id="hsRegUserComName" name="hsRegUserComName"  placeholder="Company name" value="${sessionScope.SANGHO}" readOnly/>
                        <a href="javascript:fn_customerSearch()"><img src="../images/cps/hs_seach.png" id="customerSearch" style="display:none"></a>
                        <input type="text" id="hsRegUserComTaxNum" name="hsRegUserComTaxNum"  placeholder="Business License" value="${sessionScope.TAXNO}" readOnly/>
                    ...
                    <tr>
                      <td class="left">Item code <i></i></td>
                      <td>
                      ...
                      <td>
                      	<input type="text" id="itemMcountNo" name="itemMcountNo" placeholder="Reference number"/>
                      </td>
                    </tr>
                    <tr>
