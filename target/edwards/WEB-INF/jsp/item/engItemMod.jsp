...
<%@ taglib prefix="spring" 	uri="http://www.springframework.org/tags"%>
	...
	<script type="text/javascript" src="<c:url value='/js/cps/item/engItemMod.js'/>"></script>
  </head>
  <body>
    <div id="wrap">
	  <div id="content">
		    ...
		    <div class="easyui-layout" style="width:900px;height:700px;">
		      <div data-options="region:'center'" style="box-sizing:border-box;border:0px;">
				...
				<div class="hsnew_C02_table">
				  ...
				  <input type="hidden" id="Mend_date" 		name="Mend_date">
				  ...
				  <table>
                    ...
                    <tr>
                      ...
                      <td class="left">Business License</td>
                      <td>
                    ...
                    <tr>
                      <td class="left">Standard Description</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="left">Currency/Unit price</td>
                      <td>
                        <input type="hidden" id="Munitprice_current_old" name="Munitprice_current_old"/>
                        <input type="hidden" id="Munitprice_old" name="Munitprice_old"/>
                        ...
                        <input type="text" id="Munitprice" name="Munitprice" style="width:100px;text-align:right"/>
                      </td>
                    </tr>
                    <tr>
                      <td class="left">Model</td>
                      <td colspan="3">
                        <input type="hidden" id="Mmodel_2_old" name="Mmodel_2_old"/>
                        <input type="hidden" id="Mmodel_3_old" name="Mmodel_3_old"/>
                    ...
                    <tr>
                      ...
                      <td class="left">Unit price discrepancy</td>
                      <td>
                    ...
                    <tr>
                      <td class="left">Customs Clearance</td>
                      <td colspan="3">
