		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'Impo_singo_no',title:'신고번호',width:120,align:'center',formatter:linkSingoFormatter1},
	                ...
	                {field:'impo_gyelje_money',title:'통화단위',width:50,align:'center'},
	                ...
	                {field:'Impo_indo_jogun',title:'인도조건',width:60,align:'center'},
			...
			$('#subDetailGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'Impum_sungbun3',title:'성분3',width:100}
		        ]]
			});
			...
			$('#excelGrid').datagrid({
				...
				columns	: [[
	                ...
	                {field:'impo_gyelje_money',title:'통화단위'},
	                {field:'impo_gele_gubun',title:'거래구분'},
	                ...
	                {field:'Impo_indo_jogun',title:'인도조건'},
...
var fn_searchAction5 = function(){
	...
	if (row){
		openWindowWithPost("./importOriginDetail.cps","width=1200, height=620, scrollbars=yes, location=no, menubar=no", "OriginDetail" ,{
	    	"Impo_key" 		: row.Impo_key,
