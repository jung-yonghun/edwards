		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'impo_gyelje_money',title:'Currency unit',width:50,align:'center'},
	                {field:'impo_gele_gubun',title:'Transaction Classification',width:50,align:'center'},
			...
			$('#excelGrid').datagrid({
				...
				columns	: [[
	                ...
	                {field:'impo_gyelje_money',title:'Currency unit'},
	                {field:'impo_gele_gubun',title:'Transaction Classification'},
