	...
	$(function(){
		...
		$('#masterGrid').datagrid({
			...
			columns			: [[
                ...
                {field:'costMstStatus',title:'Status',width:50,align:'center',formatter:linkCustomsCostStatusFormatter},
                {field:'costCustomerName',title:'Client',width:100},
                {field:'accountDay',title:'Settlement date',width:80,align:'center',formatter:linkDateFormatter},
                {field:'blNum',title:'B/L No.',width:120,formatter:linkBlNoFormatter},
                {field:'singoNum',title:'Declaration No.',width:120,align:'center',formatter:linkSingoFormatter},
                {field:'costShipperUserNm',title:'Forwarder',width:100},
                {field:'referenceNum1',title:'Ref No1',width:100},
                {field:'referenceNum2',title:'Ref No2',width:100},
                {field:'totalSupplyAmt',title:'Supply price(Total)',width:80,align:'right',formatter:linkNumberFormatter0},
                {field:'totalVat',title:'VAT(Total)',width:80,align:'right',formatter:linkNumberFormatter0},
                {field:'totalSumAmt',title:'Total amount',width:80,align:'right',formatter:linkNumberFormatter0},
		...
		$('#masterGrid').datagrid('enableFilter',[{
            ...
            options:{
                panelHeight:'auto',
                data:[{value:'',text:'All'},{value:'입력',text:'입력'},{value:'확인',text:'확인'}],
		...
		$('#detailGrid').datagrid({
			...
			view			: bufferview,
			columns			: [[
                {field:'costCode',title:'Code',width:50,align:'center'},
                {field:'costName',title:'Code Name',width:100},
                {field:'supplyAmt',title:'Amount',width:80,align:'right',formatter:linkNumberFormatter0},
                {field:'vat',title:'VAT',width:80,align:'right',formatter:linkNumberFormatter0},
		...
		$('#excelGrid').datagrid({
			...
			height	: _setHeight,
			columns	: [[
				{field:'costMstStatus',title:'Status'},
				{field:'costCustomerName',title:'Client'},
				{field:'accountDay',title:'Settlement date'},
				{field:'blNum',title:'B/L No.'},
				{field:'singoNum',title:'Declaration No.'},
				{field:'costShipperUserNm',title:'Forwarder'},
				{field:'referenceNum1',title:'Ref No1'},
				{field:'referenceNum2',title:'Ref No2'},
				{field:'totalSupplyAmt',title:'Supply price(Total)'},
				{field:'totalVat',title:'VAT(Total)'},
				{field:'totalSumAmt',title:'Total amount'},
				{field:'costCode',title:'Code'},
				{field:'costName',title:'Code Name'},
				{field:'supplyAmt',title:'Amount'},
				{field:'vat',title:'VAT'},
				{field:'totalAmt',title:'Total'},
	        ]]
		});
    });
...
var fn_AddImportCostMasterAction = function(){
    openWindowWithPost("./engImportCustomsCostIns.cps", "width=700, height=600, top=30, scrollbars=no, location=no, menubar=no", "importCustomsCostSave_new_", {});
};
