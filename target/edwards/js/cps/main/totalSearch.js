...
function getCommonNoticeList(keyword, name, callback, target){
    var url 	= "../apis/customs/selectZeissImportStatusList",
        params 	= {
...
function openImport(singo,target){
	if(target=="impoSingo"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
		    	...
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSingo="+ singo +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSingo="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
		    	...
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSingo="+ singo +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSingo="+ singo +"");
		    }
		}
	...
	if(target=="impoPo"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?Imlan_gije="+ singo +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?Imlan_gije="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?Imlan_gije="+ singo +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?Imlan_gije="+ singo +"");
		    }
		}
	...
	if(target=="impoBl"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoBl="+ singo +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoBl="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoBl="+ singo +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoBl="+ singo +"");
		    }
		}
	...
	if(target=="impoJajae"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoJajae="+ singo +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoJajae="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoJajae="+ singo +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoJajae="+ singo +"");
		    }
		}
	...
	if(target=="impoGuk"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoGuk="+ singo +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoGuk="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoGuk="+ singo +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoGuk="+ singo +"");
		    }
		}
	...
	if(target=="impoSung"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSung="+ singo +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSung="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSung="+ singo +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSung="+ singo +"");
		    }
		}
...
function openImportAll(target){
	if(target=="impoSingo"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSingo="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSingo="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSingo="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSingo="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="impoPo"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?Imlan_gije="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?Imlan_gije="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?Imlan_gije="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?Imlan_gije="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="impoBl"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoBl="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoBl="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoBl="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoBl="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="impoJajae"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoJajae="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoJajae="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoJajae="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoJajae="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="impoGuk"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoGuk="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoGuk="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoGuk="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoGuk="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="impoSung"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수입현황")){
				parent.$('#tt').tabs('close', "수입현황");
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSung="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수입현황", "../special/zeissImportOriginList.cps?impoSung="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Import Status")){
				parent.$('#tt').tabs('close', "Import Status");
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSung="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Import Status", "../special/zeissImportOriginEngList.cps?impoSung="+ $('#keyword').val() +"");
		    }
		}
...
function openExport(singo,target){
	if(target=="expoSingo"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
		    	...
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSingo="+ singo +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSingo="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
		    	...
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSingo="+ singo +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSingo="+ singo +"");
		    }
		}
	...
	if(target=="expoInv"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoInv="+ singo +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoInv="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoInv="+ singo +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoInv="+ singo +"");
		    }
		}
	...
	if(target=="expoJajae"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoJajae="+ singo +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoJajae="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoJajae="+ singo +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoJajae="+ singo +"");
		    }
		}
	...
	if(target=="expoGuk"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoGuk="+ singo +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoGuk="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoGuk="+ singo +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoGuk="+ singo +"");
		    }
		}
	...
	if(target=="expoSung"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSung="+ singo +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSung="+ singo +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSung="+ singo +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSung="+ singo +"");
		    }
		}
...
function openExportAll(target){
	if(target=="expoSingo"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSingo="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSingo="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSingo="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSingo="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="expoInv"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoInv="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoInv="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoInv="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoInv="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="expoJajae"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoJajae="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoJajae="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoJajae="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoJajae="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="expoGuk"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoGuk="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoGuk="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoGuk="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoGuk="+ $('#keyword').val() +"");
		    }
		}
	...
	if(target=="expoSung"){
		if($('#setMenu').val()=="K"){
			if(parent.$('#tt').tabs('exists', "수출현황")){
				parent.$('#tt').tabs('close', "수출현황");
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSung="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("수출현황", "../special/zeissExportOriginList.cps?expoSung="+ $('#keyword').val() +"");
		    }
		}else{
			if(parent.$('#tt').tabs('exists', "Export Status")){
				parent.$('#tt').tabs('close', "Export Status");
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSung="+ $('#keyword').val() +"");
		    }else{
		    	parent.addTab("Export Status", "../special/zeissExportOriginEngList.cps?expoSung="+ $('#keyword').val() +"");
		    }
		}
