		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
					...
					{field:'Expo_singo_date',title:'신고일',width:80,align:'center'},
				...
				onSelect	: function(rowIndex, rowData){
					...
					fn_fileListAction("EXPORT",rowData.Expo_key,rowData.Expo_iv_no,rowData.Expo_singo_no,rowData.Expo_singo_date);
		        }
			});
...
function linkExSingoFormatter1(value,row){
	if (isEmpty(value) || row.CUS_BUHO == ""){
		...
		var Singo = value.replace(/-/g,'');
		return "<u><a href='javascript:linkExSingoNo(\""+ Singo +"\")'><font color='#333333'>" + value + "</font></a></u>";
	}
}