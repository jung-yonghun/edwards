...
$(document).ready(function(){
	if(isEmpty($('#ID').val())){
		...
		$(function setDatePicker(){
			...
			var dates = $("#frm1 #IMPT_CMPL_DT").datepicker({
				changeMonth 	: true,
				changeYear 		: true,
...
var fn_saveAction = function(){
	if(parseInt(document.frm1.EXPT_QTY.value) < parseInt(document.frm1.IMPT_QTY.value)){
    ...
    params["checkQty"] = parseInt(document.frm1.EXPT_QTY.value) - parseInt(document.frm1.IMPT_QTY.value);
    ...
    params["ReQTY"] = parseInt(document.frm1.IMPT_QTY.value);
    params["useYn"] = "Y";
    params["confirmChk"] = "Y";
