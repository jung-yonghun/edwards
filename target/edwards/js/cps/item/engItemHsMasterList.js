		...
		$(function(){
			$('#masterGrid').jqGrid({
	            ...
	            colModel	: [
	                ...
	                {label:'Requestor', name:'hsRegUserNm', index:'hsRegUserNm', width:60, align:'center'},
	                {label:'Request date', name:'hsRegDt', index:'hsRegDt', width:70, align:'center', formatter:linkDateFormatter},
	                {label:'Official Inquiry', name:'hsStatus_cus', index:'hsStatus_cus', width:70, align:'center',
	                	edittype		: 'select',
	                ...
	                {label:'Status', name:'hsStatus', index:'hsStatus', width:50, align:'center',
	                	edittype		: 'select',
	                ...
	                {label:'Due date', name:'hsReviewDt', index:'hsReviewDt', width:70, align:'center', formatter:linkDateFormatter},
	                {label:'Passed days', name:'aaa', index:'aaa', width:40, align:'right', formatter:linkDateCheckFormatter},
	                {label:'Company name', name:'hsRegUserComName', index:'hsRegUserComName', width:200},
	                {label:'Product name', name:'itemMstdGoods', index:'itemMstdGoods', width:200},
	                {label:'Product number', name:'itemMmodelCode', index:'itemMmodelCode', width:150},
	                {label:'Registered HS', name:'itemHs', index:'itemHs', width:90, align:'center', formatter:linkHsFormatter},
	                {label:'Confirmed HS', name:'itemOkHs', index:'itemOkHs', width:90, align:'center', formatter:linkHsFormatter},
	                {label:'Updated Y/N', name:'itemUpdate', index:'itemUpdate', width:50, align:'center'},
	                {label:'Priority', name:'hsImportance', index:'hsImportance', width:40, align:'center',
	                	edittype		: 'select',
	                ...
	                {label:'Urgent', name:'hsEmergencyYn', index:'hsEmergencyYn', width:30, align:'center',
	                	edittype		: 'select',
	                    editoptions		: {value:"Y:Y;N:N;", defaultValue:"N"},
	                    stype			: 'select',
	                    searchoptions	: {sopt:['eq'], value:':전체;Y:Y;N:N'}
	                },
	                {label:'Reasons for request', name:'hsReqType', index:'hsReqType', width:50, align:'center',
	                	edittype		: 'select',
	                ...
	                {label:'Product type', name:'itemType', index:'itemType', width:50, align:'center',
	                	edittype		: 'select',
	                ...
	                {label:'Confirmer', name:'hsOkUserNm', index:'hsOkUserNm', width:60, align:'center'},
	                {label:'Reference number', name:'hsRegNum', index:'hsRegNum', width:100, align:'center'},
	        ...
	        $('#excelGrid').jqGrid({
				...
				colModel 		: [
	                {label:'Requestor', name:'hsRegUserNm', index:'hsRegUserNm', width:60, align:'center'},
	                {label:'Request date', name:'hsRegDt', index:'hsRegDt', width:70, align:'center', formatter:linkDateFormatter},
	                {label:'Official Inquiry', name:'hsStatus_cus', index:'hsStatus_cus', width:70, align:'center', formatter:linkStatusExFormatter},
	                {label:'Status', name:'hsStatus', index:'hsStatus', width:50, align:'center', formatter:linkStatusFormatter},
	                {label:'Due date', name:'hsReviewDt', index:'hsReviewDt', width:70, align:'center', formatter:linkDateFormatter},
	                {label:'Passed days', name:'aaa', index:'aaa', width:40, align:'right', formatter:linkDateCheckFormatter},
	                {label:'Company name', name:'hsRegUserComName', index:'hsRegUserComName', width:200},
	                {label:'Product name', name:'itemMstdGoods', index:'itemMstdGoods', width:200},
	                {label:'Product number', name:'itemMmodelCode', index:'itemMmodelCode', width:150},
	                {label:'Registered HS', name:'itemHs', index:'itemHs', width:90, align:'center'},
	                {label:'Confirmed HS', name:'itemOkHs', index:'itemOkHs', width:90, align:'center'},
	                {label:'Updated Y/N', name:'itemUpdate', index:'itemUpdate', width:50, align:'center'},
	                {label:'Priority', name:'hsImportance', index:'hsImportance', width:40, align:'center', formatter:linkImportanceFormatter},
	                {label:'Urgent', name:'hsEmergencyYn', index:'hsEmergencyYn', width:30, align:'center'},
	                {label:'Reasons for request', name:'hsReqType', index:'hsReqType', width:50, align:'center', formatter:linkReqTypeFormatter},
	                {label:'Product type', name:'itemType', index:'itemType', width:50, align:'center', formatter:linkItemTypeFormatter},
	                {label:'Confirmer', name:'hsOkUserNm', index:'hsOkUserNm', width:60, align:'center'},
	                {label:'Reference number', name:'hsRegNum', index:'hsRegNum', width:100, align:'center'}
				],
				height : 230,
			...
			$('#fileGrid').jqGrid({
				...
				colModel 		: [
	                ...
	                {label:'File name', name:'originFileNm', index:'originFileNm', width:240},
	                {label:'Registerer', name:'addUserNm', index:'addUserNm', width:50, align:'center'},
	                {label:'Registration', name:'addDtm', index:'addDtm', width:70, align:'center', formatter:linkDateFormatter},
	                {label:'Open', name:'a', index:'a', width:30, align:'center', formatter:linkItemDownloadFormatter},
	                {label:'Delete', name:'b', index:'b', width:30, align:'center', formatter:linkItemDelFormatter}
				],
				height : 170,
				autowidth: true,
				shrinkToFit: false,
...
var fn_insertAction = function(){
	if($("#ID").val()=="153" || $("#ID").val()=="327" || $("#ID").val()=="328" || $("#ID").val()=="329" || $("#ID").val()=="330" || $("#ID").val()=="331"){
		openWindowWithPost("./engItemHsFtaIns.cps", "width=900, height=500, top=30, scrollbars=no, location=no, menubar=no", "itemHsIns", {});
	}else{
		openWindowWithPost("./engItemHsIns.cps", "width=900, height=500, top=30, scrollbars=no, location=no, menubar=no", "itemHsIns", {});
	}
};