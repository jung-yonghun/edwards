		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'Status',title:'문서상태',width:120},
	                {field:'Etc01',title:'세관접수',width:120},
	                ...
	                {field:'PaymentDanwi',title:'총결제금액단위',width:80,align:'right',formatter:linkNumberFormatter0},
	                ...
	                {field:'ItemNm',title:'담당자',width:80}
		        ]],
			...
			$('#detailGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'HsCode',title:'HS Code',width:80,align:'center',formatter:linkHsFormatter},
	                ...
	                {field:'InvNo',title:'Invoice No',width:80},
	                {field:'BlNo',title:'B/L No',width:80},
	                {field:'Etc03',title:'신구품',width:80},
	                {field:'Etc04',title:'신구품(코드)',width:80},
	                {field:'LicenseNo',title:'허가번호',width:80},
	                {field:'Etc05',title:'제조원상호1',width:80},
	                {field:'Etc06',title:'제조원상호2',width:80},
	                {field:'Etc07',title:'제조원상호3',width:80},
	                {field:'Etc02',title:'제조원국가코드',width:80},
	                {field:'Etc09',title:'제조자상호1',width:80},
	                {field:'Etc10',title:'제조자상호2',width:80},
	                {field:'Etc11',title:'제조자상호3',width:80},
	                {field:'Etc08',title:'제조자국가코드',width:80},
	                {field:'Etc12',title:'시험용 용도구분',width:80},
	                {field:'Etc13',title:'시험용 등 확인번호',width:80}
		        ]]
			});
	    });
...
var fn_DetailAction = function (ApplyNo){
	...
	progress.show();
	var url 	= "../apis/compliance/selectResultMasterList",
		params 	= {"ApplyNo" : ApplyNo, "RqGbn" : "DD"},
		type 	= "POST";
