		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'ee',title:'Inv No.',width:100,align:'center'},
	                {field:'ff',title:'자재코드',width:50,align:'center'},
	                {field:'gg',title:'규격1',width:100,align:'center'},
	                {field:'hh',title:'형명',width:100,align:'center'},
	                {field:'ii',title:'수량',width:100,align:'center'},
	                {field:'jj',title:'단가',width:50,align:'center'},
	                {field:'kk',title:'품목수',width:100,align:'center'},
	                {field:'ll',title:'총액',width:100,align:'center'},
	                {field:'mm',title:'요건수수료',width:80,align:'center'},
