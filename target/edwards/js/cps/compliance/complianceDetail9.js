		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'comName',title:'수입자',width:100,align:'center'},
	                {field:'aa',title:'B/L No.',width:200,align:'center'},
	                {field:'bb',title:'Inv No.',width:80,align:'center'},
	                {field:'cc',title:'Item No.',width:80,align:'center'},
	                {field:'dd',title:'신고제품구분',width:100,align:'center'},
	                {field:'ee',title:'영문명',width:100,align:'center'},
	                {field:'ff',title:'한글명',width:50,align:'center'},
	                {field:'gg',title:'입항',width:100,align:'center'},
	                {field:'hh',title:'반입',width:100,align:'center'},
	                {field:'ii',title:'검사검역접수',width:100,align:'center'},
	                {field:'jj',title:'검사검역완료',width:50,align:'center'},
	                {field:'uu',title:'수량',width:50,align:'center'},
	                {field:'vv',title:'중량',width:50,align:'center'},
	                {field:'kk',title:'원산지',width:100,align:'center'},
	                {field:'ll',title:'실비1(Vat별도)',width:100,align:'center'},
	                {field:'mm',title:'실비2(Vat별도)',width:80,align:'center'},
	                {field:'oo',title:'대행수수료(Vat별도)',width:50,align:'center'},
	                {field:'pp',title:'검사선별여부',width:60,align:'center'},
	                {field:'qq',title:'해외제조업소',width:80,align:'center'},
	                {field:'rr',title:'해외제조업소 or 수출자',width:80,align:'center'},
	                {field:'ss',title:'비고',width:80,align:'center'},
	                {field:'tt',title:'계산서발행',width:80,align:'center'},
		        ]],
