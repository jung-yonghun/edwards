		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'comName',title:'요건항목',width:100,align:'center'},
	                {field:'aa',title:'입항일',width:80,align:'center'},
	                {field:'bb',title:'B/L No.',width:100,align:'center'},
	                {field:'cc',title:'Import No.',width:100,align:'center'},
	                {field:'dd',title:'Order No.',width:100,align:'center'},
	                {field:'ee',title:'Retail or Online',width:100,align:'center'},
	                {field:'ff',title:'제품명',width:100,align:'center'},
	                {field:'gg',title:'용량/중량',width:40,align:'center'},
	                {field:'hh',title:'수량',width:40,align:'center'},
	                {field:'ii',title:'단가',width:60,align:'center'},
	                {field:'jj',title:'HS CODE',width:60,align:'center'},
	                {field:'kk',title:'해외제조사',width:100,align:'center'},
	                {field:'ll',title:'제조번호',width:100,align:'center'},
	                {field:'mm',title:'제조일자',width:80,align:'center'},
	                {field:'nn',title:'사용기한',width:50,align:'center'},
	                {field:'oo',title:'제조국',width:50,align:'center'},
	                {field:'pp',title:'요건발급번호',width:80,align:'center'},
	                {field:'qq',title:'New or Repeated',width:80,align:'center'},
	                {field:'rr',title:'신청일자',width:80,align:'center'},
	                {field:'ss',title:'발급일자',width:80,align:'center'},
	                {field:'tt',title:'EDI 처리기한',width:80,align:'center'},
	                {field:'uu',title:'입항일~ EDI처리기한',width:80,align:'center'},
	                {field:'vv',title:'Q.C Test시험항목',width:80,align:'center'},
	                {field:'ww',title:'Q.C 시료수',width:80,align:'center'},
	                {field:'xx',title:'Q.C 신청일자',width:80,align:'center'},
	                {field:'yy',title:'Q.C 발급일자',width:80,align:'center'},
	                {field:'zz',title:'성적서번호',width:80,align:'center'},
	                {field:'aaa',title:'업로드',width:50,align:'center'},
	                {field:'bbb',title:'계산서발행여부',width:60,align:'center'},
	                {field:'ccc',title:'발행일자',width:80,align:'center'},
		        ]],
