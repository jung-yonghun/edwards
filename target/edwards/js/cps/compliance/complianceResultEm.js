		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'ComSangho',title:'납세자상호',width:120},
	                {field:'SenderSangho',title:'공급자상호',width:200},
			...
			$('#excelGrid').datagrid({
				...
				columns	: [[
	                ...
	                {field:'ComSangho',title:'납세자상호'},
	                {field:'SenderSangho',title:'공급자상호'},
	                {field:'Su',title:'총수량'},
...
var fn_DetailAction = function (ApplyNo){
	...
	progress.show();
	var url 	= "../apis/compliance/selectResultMasterList",
		params 	= {"ApplyNo" : ApplyNo, "RqGbn" : "ED"},
		type 	= "POST";
