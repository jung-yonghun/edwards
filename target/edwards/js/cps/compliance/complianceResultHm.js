	...
	if(isEmpty($('#ID').val())){
		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				view			: bufferview,
				columns			: [[
	                {field:'SendNo',title:'관리번호',width:150},
	                ...
	                {field:'Etc17',title:'수입자코드',width:120},
	                {field:'ComSangho',title:'수입자',width:120},
	                {field:'Etc18',title:'수입자 사업번호구분',width:80},
	                ...
	                {field:'Etc21',title:'송하인 코드',width:120},
			...
			$('#detailGrid').datagrid({
				...
				columns			: [[
	                ...
	                {field:'SenderSangho',title:'제조자 공장명',width:150},
