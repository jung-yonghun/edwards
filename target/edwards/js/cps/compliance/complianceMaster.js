	...
	if(isEmpty($('#ID').val())){
		...
		$(function(){
			...
			$('#masterGrid').datagrid({
				...
				columns			: [[
	                {field:'yogCom',title:'업체명',width:200},
	                {field:'codeName',title:'요건코드(품목)',width:120},
	                {field:'jajaeCode',title:'통관자재코드',width:120},
	                {field:'hsCode',title:'HS CODE',width:100,align:'center',formatter:linkHsFormatter},
	                {field:'식품',title:'식품',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'식물',title:'식물',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'동물',title:'동물',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'축산물',title:'축산물',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'수산물',title:'수산물',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'전기',title:'전기',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'전파',title:'전파',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'공산품',title:'공산품',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'화장품',title:'화장품',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'자동차',title:'자동차부품',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'화학',title:'화학물질',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'방폭',title:'방폭면제',width:60,align:'center',formatter:linkCountFormatter},
	                {field:'의료',title:'의료기기',width:60,align:'center',formatter:linkCountFormatter},
		        ]],
			...
			$('#masterGrid').datagrid('enableFilter',[{
	            ...
	            options:{
	                panelHeight:'auto',
	                data:[{value:'',text:'전체'},{value:'N',text:'N'},{value:'Y',text:'Y'}],
